|slug|distributed-execution-of-sql-under-tenants|
|---|---|
...
单机 TopSQL 的 **<UI-TERM key="ocp-v2.SQLDiagnosis.Component.ColumnManager.ColumnManagement">列管理</UI-TERM>**，勾选 **分布式计划占比（%）** 选项，并选择根据 **<UI-TERM key="ocp-v2.src.constant.sqlDiagnosis.ProportionOfDistributedPlans">分布式计划占比</UI-TERM>** 列进行排序。
