|slug|ocp-agent-data-push-scheme|
|---|---|
...
监控接口开关：`ocp.agent.auth.metric-auth-enabled`，默认值为 true（开启鉴权），在 OCP **<UI-TERM key="ocp-v2.page.Property.SystemParameters">系统参数</UI-TERM>** 中修改参数值为 false，即可通过 pull 模式对接监控。
