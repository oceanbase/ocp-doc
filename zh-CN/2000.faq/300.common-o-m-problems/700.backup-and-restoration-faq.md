...
A: 请以该任务 **<UI-TERM key="ocp-v2.Backup.Restore.RestoreTask.State">状态</UI-TERM>** 列的结果为实际参考。
...
A: 正常，OceanBase 的参数 restore_concurrency 生效可能延迟，所以 OCP 会报错。如果 **<UI-TERM key="ocp-v2.Backup.Restore.InitiateRecovery">发起恢复</UI-TERM>** 能提交成功则可忽略该报错。
