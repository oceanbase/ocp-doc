...
**Q4：OCP 多集群模式下，在备 OCP 集群中创建 OBProxy 集群，并为其关联远程主 OCP 中的 OceanBase 集群。切换到主 OCP 中后，发现 OceanBase 集群无法查看到已关联的 OBProxy 集群，该如何解决？**
...
A: 建议先执行 [标准化主机](../../850.host-features/100.manage-a-host/600.normalization-agent.md)后，再尝试部署 OBProxy。
