...
|-------------|-----------------------|--------|
| block_cache | block_cache_req_total | -      |
...
|------------|----------------------|--------|
| clog_cache | clog_cache_req_total | -      |
...
|-------------------|------------------------------|--------|
| bloom_filter_cache | bloom_filter_cache_req_total | -      |
...
|    **<UI-TERM key="ocp-v2.Monitor.AddMonitor.IndicatorItem">指标项</UI-TERM>**     |           指标名称           | **<UI-TERM key="ocp-v2.Component.ShowLimitsModal.Unit">单位</UI-TERM>** |
|----------------|--------------------------|--------|
| location_cache | location_cache_req_total | -      |
