...
本节为您介绍 OceanBase 租户的监控指标 **<UI-TERM key="ocp-v2.page.Diagnosis.LogDisk">日志盘</UI-TERM>** 。您可指定统计范围，查询租户在单个 Zone 或 OBServer 节点的 **<UI-TERM key="ocp-v2.page.Diagnosis.LogDisk">日志盘</UI-TERM>** 数据。
