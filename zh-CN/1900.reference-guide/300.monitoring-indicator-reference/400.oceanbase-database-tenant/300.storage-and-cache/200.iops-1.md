...
|---------|----------|--------|
| ssstore_read    | io_read_count | times/s      |
...
|---------|----------|--------|
| ssstore_write  | io_write_count | times/s      |
...
|---------|----------|--------|
| clog_read  | clog_io_read_count | times/s      |
...
|---------|----------|--------|
| clog_write  | clog_io_write_count | times/s      |
