|slug|time-consumed-by-io-operations-1|
|---|---|

# 物理 IO 耗时

本节为您介绍 OceanBase 租户的性能指标 **物理 IO 耗时** 。您可指定统计范围，查询 OceanBase 租户在单个 Zone 或 OBServer 节点的 **物理 IO 耗时** 数据。

## ssstore_read

### 指标介绍

统计范围内，租户每次读取 SSStore 的平均耗时。
