...
|-------------------------|------------|-------|-------|------|
| mem_assigned_percent    | 98         | 0 秒  | 20 秒 | 5 分钟 |
...
* **告警概述**
  ...
  * 样例：alarm_template_id=0:ob_cluster=obcluster-1:host=xxx.xxx.xxx.xxx OceanBase 已经分配给租户的内存占比超限
