...
**监控指标** ob_disk_percent 的值表示 OBServer 节点数据盘使用率，当该值大于阈值时触发告警。

## 规则信息

|           监控指标            | 默认阈值（单位：%） | 持续时间 | 检测周期 | 消除周期 |
|---------------------------|------------|------|------|------|
| ob_disk_percent | 该指标存在如下两个默认阈值：<li>85</li><li>97</li>       | 0 秒  | 20 秒 | 5 分钟 |

## 告警信息

|   告警触发方式   | 告警等级 | 范围  |
|------------|------|-----|
| 基于监控指标的表达式 | <li>ob_disk_percent > 85：警告</li><li>ob_disk_percent > 97：严重</li>   | 服务器 |
