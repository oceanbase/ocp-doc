...
* 告警详情模板：集群：\${ob_cluster_name}，告警：\${alarm_name} OceanBase 集群活跃会话数：\${value}，超过阈值 \${alarm_threshold}。

* 告警概述样例：ob_cluster=obcluster-1 OceanBase 集群活跃会话数超限

* 告警详情样例：集群：obcluster-1，告警：OceanBase 集群活跃会话数超限，OceanBase 集群活跃会话数：11000，超过阈值 10000。
