...
|-----------------|-----------|---------|----------|------|
| tenant_partition_replica_absent_count | 100     | 180 秒    | 20 秒    | 5 分钟 |
...
* **告警恢复**
  ...
  * 模板：告警：${alarm_name}，租户缺副本分区个数：${recover_value}
  * 样例：告警：OceanBase 租户分区缺副本，租户缺副本分区个数：85
