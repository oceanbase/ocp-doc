...
# ob_tenant_expired_trans_exist OceanBase 租户存在悬挂事务

## 告警描述

租户中存在事务停留在提交阶段 1200 秒以上则触发该告警。
...
|------------------------------------|------|--------|------|------|
| pending_trans_max_duration_seconds | 1200 | 0 秒   | 20 秒 | 5 分钟 |
...
* **告警概述**
  ...
  * 样例：alarm_template_id=0:ob_cluster=obcluster-1:tenant_name=orac2:trans_hash=7728549 OceanBase 租户存在悬挂事务
...
* **告警详情**
  ...
  * 样例：集群：obcluster-1，租户：orac2 存在悬挂事务。会话 ID：3221635048，事务 ID：7728549，事务类型：distribute，事务创建时间：2022-03-11T18:05:21.184+08:00，事务最长持续时长：25 天 19 小时 57 分 24.66 秒。

* **告警恢复**

  * 模板：告警：${alarm_name}
  * 样例：告警：OceanBase 租户存在悬挂事务
