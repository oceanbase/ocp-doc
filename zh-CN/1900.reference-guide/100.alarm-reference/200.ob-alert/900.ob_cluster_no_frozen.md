...
* **告警概述**
  ...
  * 样例：alarm_template_id=0:ob_cluster=obcluster-1 OceanBase 集群长时间未冻结

* **告警详情**

  * 模板：集群：\${ob_cluster_name}，告警：\${alarm_name}。距上一次冻结时间为 \${value_shown} 超过 ${alarm_threshold} 秒。
  * 样例：集群：obcluster-1，告警：OceanBase 集群长时间未冻结。距上一次冻结时间为 1 小时 17 分 49.496 秒超过 40 秒。

* **告警恢复**

  * 模板：告警：${alarm_name}，OceanBase 集群距离上一次冻结的间隔：\${value_shown} 秒
  * 样例：告警：OceanBase 集群长时间未冻结，OceanBase 集群距离上一次冻结的间隔：70000.0 秒
