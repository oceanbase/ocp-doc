...
|  参数   |     值    |
|-------|-----------|
| 监控指标  | merge_timeout_flag      |
| 指标来源  | SQL：`select zone, name, value, time_to_usec(now()) from __all_zone;` <blockquote>**<UI-TERM key="ocp-v2.TakeOver.Component.ParameterDiffDrawer.Description">说明</UI-TERM>**</br>zone_value 取 value 字段的值，其他字段作为 LABELS。</blockquote> |
| 采集指标  | zone_value                                                                                                                                                                                     |
