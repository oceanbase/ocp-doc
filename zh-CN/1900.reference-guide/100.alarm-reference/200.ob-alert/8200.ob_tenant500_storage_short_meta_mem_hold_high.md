...
| 参数 | 值 |
| --------- | --------- |
| 监控指标 | tenant500_storage_short_meta_hold_percentage、tenant500_storage_short_meta_hold_gb，其中：<ul><li>tenant500_storage_short_meta_hold_percentage：该指标表示 500 租户 STORAGE_SHORT_TERM 模块内存占用百分比。</li><li>tenant500_storage_short_meta_hold_gb：该指标表示 500 租户 STORAGE_SHORT_TERM 模块内存占用大小。</li></ul>当指标值均大于阈值时触发告警。   |
