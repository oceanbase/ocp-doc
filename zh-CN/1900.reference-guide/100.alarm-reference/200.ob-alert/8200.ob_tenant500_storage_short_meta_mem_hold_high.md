...
| tenant500_storage_short_meta_hold_percentage > 30 and tenant500_storage_short_meta_hold_gb > 0 | 500 租户 STORAGE_SHORT_TERM 模块内存占用百分比过高

## 规则信息

| 监控指标 | 默认阈值 | 持续周期 | 检测周期 | 消除周期 |
| -------- | ------- | ------- | ------- | -------- |
| tenant500_storage_short_meta_hold_percentage、tenant500_storage_short_meta_hold_gb | <li>tenant500_storage_short_meta_hold_percentage：30</li><li>tenant500_storage_short_meta_hold_gb：0</li> | 30 | 20 秒 | 5 分钟 |
