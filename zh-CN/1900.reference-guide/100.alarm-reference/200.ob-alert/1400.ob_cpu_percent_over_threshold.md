...
|----------------|------------|------|------|------|
| ob_cpu_percent | 80         | 60 秒 | 10 秒 | 5 分钟 |
...
* **告警详情**
  ...
  * 样例：集群：obcluster-1，主机：xxx.xxx.xxx.xxx，告警：OceanBase 租户线程平均使用率 91.0 % 超过 90.0 %。

* **告警恢复**

  * 模板：告警：${alarm_name}，OceanBase 服务器上租户线程平均使用率：\${value_shown}
  * 样例：告警：OceanBase 服务器上租户线程平均使用率超限，OceanBase 服务器上租户线程平均使用率：89 %
