...
* **告警概述**
  ...
  * 样例: alarm_template_id=0:ob_cluster=obcluster-1 Config server 中 rootserver 信息不正确

* **告警详情**

  * 模板: OceanBase 集群 \${ob_cluster_name}:${ob_cluster_id} rootserver 信息与 config server 中 rootserver 信息不一致，请检查 OceanBase 集群的 configUrl 配置
  * 样例: OceanBase 集群 obcluster-1:10000 rootserver 信息与 config server 中 rootserver 信息不一致，请检查 OceanBase 集群的 configUrl 配置
