...
* * **告警概述**
  ...
  * 样例：alarm_template_id=0:ob_cluster=cluster_A-4:tenant_name=tenant1:db_name=test:sql_id=142A49D034B27871DE8E646F3360****:recommend_operations=FLUSHING_PLAN_CACHE SQL 巡检，SQL 性能下降

* **告警详情**

  * 模板：在时间段 ${start_time} - ${end_time} 内，租户 ${tenant_name}，数据库 ${db_name}，发现异常 SQL ${sql_id}，性能下降。平均 CPU 时间 ${sql_cpu_time_ms} ms，平均响应时间 ${sql_elapsed_time_ms} ms，基线时间段 ${baseline_start_time} - ${baseline_end_time}，基线时间段内，平均 CPU 时间 ${sql_baseline_cpu_time_ms} ms，平均响应时间 ${sql_baseline_elapsed_time_ms} ms，建议 【刷新 PlanCache】。
  * 样例：时间段：2023-09-08T14:24:17 - 2023-09-08T14:28:47 内，租户 tenant1，数据库 test，发现异常 SQL 6CE3107B0430F8CA5AAE8B5094EC*\*\*\*，性能下降。平均 CPU 时间 1.78 ms，平均响应时间 1.78 ms，基线时间段：2023-09-08T14:04:17 - 2023-09-08T14:23:47，基线时间段内，平均 CPU 时间 1.39 ms，平均响应时间 1.39 ms，建议操作【刷新 Plan Cache】。
