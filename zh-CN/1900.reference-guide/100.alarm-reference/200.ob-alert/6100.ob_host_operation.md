...
# ob_host_operation OceanBase 服务器运维操作提醒

## 告警描述

对 OBServer 执行运维任务后会发出一条 **<UI-TERM key="ocp-v2.src.constant.alarm.Reminder">提醒</UI-TERM>** 级别的告警，告警等级可以改为其他等级。
...
* 告警概述
  ...
  * 样例：alarm_template_id=0:ob_cluster=ob1-1:host=xxx.xxx.xxx.xxx:operation_name=Restart observer SUCCESS
