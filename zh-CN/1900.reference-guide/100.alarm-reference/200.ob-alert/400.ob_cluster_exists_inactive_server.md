...
* **告警概述**
  ...
  * 样例：ob_cluster=obcluster-1 OceanBase 集群存在不工作 OBServer

* **告警详情**

  * 模板：集群：\${ob_cluster_name}，告警：\${alarm_name}，不工作 OBServer 数量为 \${value}，不工作 OBServer 有 ${server_ips}。
  * 样例：集群：obcluster-1，告警：OceanBase 集群存在不工作 OBServer，不工作 OBServer 数量为 2.0，不工作 OBServer 有 xxx.xxx.xxx.1,xxx.xxx.xxx.2。
