...
* 告警详情
  ...
  * 样例：集群：obcluster-1，告警：OceanBase 集群存在不工作 OBServer 节点，不工作 OBServer 节点数量为 2.0 ，不工作 OBServer 节点为 xxx.xxx.xxx.1,xxx.xxx.xxx.2

* 告警恢复
  * 模板：\${alarm_name}，OceanBase 集群不工作 OBServer 数量 \${recover_value}
  * 样例：OceanBase 集群存在不工作 OBServer 节点，OceanBase 集群不工作 OBServer 数量 0
