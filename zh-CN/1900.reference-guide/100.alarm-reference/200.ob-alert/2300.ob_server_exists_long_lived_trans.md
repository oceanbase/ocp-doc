|slug|ob_server_exists_long_lived_trans|
|---|---|
...
| **<UI-TERM key="ocp-v2.component.ParameterTemplate.Parameter">参数</UI-TERM>** | **<UI-TERM key="ocp-v2.page.MultiCluster.Parameter.Value">值</UI-TERM>** |
| --- | --- |
...
| **监控指标** | **默认阈值（单位：秒）** | **<UI-TERM key="ocp-performance-report.ReportTable.ActivityOverTime.ActivityOverTimeTable.Duration">持续时间</UI-TERM>** | **<UI-TERM key="ocp-v2.Alarm.Template.New.AlarmCycle">告警周期</UI-TERM>** | **<UI-TERM key="ocp-v2.Alarm.Template.Detail.EliminationCycle">消除周期</UI-TERM>** |
| --- | --- | --- | --- | --- |
| ob_server_max_trans_duration_seconds | 1200 | 0 秒 | 60 秒 | 5 分钟 |

## 告警信息

| **告警触发方式** | **<UI-TERM key="ocp-v2.component.alarm.RuleDetail.AlertLevel">告警等级</UI-TERM>** | **范围** |
| --- | --- | --- |
| 基于监控指标的表达式 | 严重 | 服务器 |
