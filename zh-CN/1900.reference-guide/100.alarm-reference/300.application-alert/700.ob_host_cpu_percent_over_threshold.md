|slug|ob_host_cpu_percent_over_threshold|
|---|---|
...
* 告警概述样例：ob_cluster=obcluster-1:svr_ip=xxx.xxx.xxx.xxx OB 服务器 CPU 使用率超限

* 告警详情样例：集群：obcluster-1，主机：xxx.xxx.xxx.xxx，告警：OB 服务器 CPU 使用率超限，CPU 使用率 101.0 % 超过 100.0 %
