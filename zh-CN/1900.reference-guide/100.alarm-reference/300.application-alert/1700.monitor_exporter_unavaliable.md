...
# monitor_exporter_unavaliable 服务器存在监控 exporter 异常
...
* **告警概述**
  ...
  * 样例：alarm_template_id=0:host=xxx.xxx.xxx.xxx:exporter=/metrics/obproxy 服务器存在监控 exporter 异常
...
* **告警恢复**
  ...
  * 样例：告警：服务器存在监控 exporter 异常，监控 exporter 是否正常：1

其中，${alarm_target} 表示产生告警的对象，格式为 `alarm_template_id=0:host=xxx.xxx.xxx.xxx:exporter=xxx`，exporter 为监控采集地址。
