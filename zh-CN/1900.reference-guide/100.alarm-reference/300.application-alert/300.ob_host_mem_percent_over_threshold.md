...
|---------------------|----------|------|------|------|
| ob_host_mem_percent | 该指标存在如下两个默认阈值：<li>95</li><li>97</li>   | 0 秒  | 60 秒 | 5 分钟 |

## **<UI-TERM key="ocp-v2.Cluster.Component.ClusterList.AlarmInformation">告警信息</UI-TERM>**

|   告警触发方式   | 告警等级 | 范围  |
|------------|------|-----|
| 基于监控指标的表达式 | <li>ob_host_mem_percent > 95：警告</li><li>ob_host_mem_percent > 97：严重</li>   | 服务器 |
...
* **告警概述**
  ...
  * 样例：ob_cluster=obcluster-1:svr_ip=xxx.xxx.xxx.xxx 服务器内存使用率超限
