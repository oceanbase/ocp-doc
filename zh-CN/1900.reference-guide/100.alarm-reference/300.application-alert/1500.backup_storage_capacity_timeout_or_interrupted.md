...
|  参数   |        值      |
|---------|----------|
| 监控指标  | storage_capacity_monitor_error_code，该指标代表 OCP-Server 监控备份恢复存储容量时采集来的错误码，当监控指标值为 1002 时触发告警。    |
...
|-------------------------------------|----------|------|-------|------|
| storage_capacity_monitor_error_code | 1002   | 0 秒   | 60 秒 | 5 分钟 |
...
* **告警概述**
  ...
  * 样例：alarm_template_id=0:ob_cluster=obcluster-1:storage_url=file:///obbackup/yc225_214/inc_data/ 备份恢复目录容量获取超时或线程被中断
