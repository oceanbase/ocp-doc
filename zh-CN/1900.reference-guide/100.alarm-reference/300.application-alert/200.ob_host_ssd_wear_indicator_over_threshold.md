...
* **告警详情**
  ...
  * 模板：集群：\${ob_cluster_name}，主机：\${host}，告警：\${alarm_name}。SSD 使用百分比 \${value_shown} 超过 \${alarm_threshold} %。
  * 样例：集群：obcluster-1，主机：xxx.xxx.xxx.xxx，告警：服务器 SSD 使用百分比超限。SSD 使用百分比 97 % 超过 95 %。

* **告警恢复**

  * 模板：告警：${alarm_name}，服务器 SSD 使用百分比：\${value_shown}
  * 样例：告警：服务器 SSD 使用百分比超限，服务器 SSD 使用百分比：90 %
