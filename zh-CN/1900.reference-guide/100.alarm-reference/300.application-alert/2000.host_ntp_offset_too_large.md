...
|------------------------------|-------------|------|------|------|
| host_ntp_offset_milliseconds | 该指标存在如下两个默认阈值：<li>100</li><li>50</li>     | 30 秒    | 10 秒 | 5 分钟 |

## 告警信息

|   告警触发方式   | 告警等级 | 范围  |
|------------|------|-----|
| 基于监控指标的表达式 | <li>host_ntp_offset_milliseconds > 100：停服</li><li>host_ntp_offset_milliseconds > 50：严重</li>     | 主机 |
