...
* **告警详情**
  ...
  * 模板：自愈预案 ${contingency_plan_name} ${contingency_plan_id} 执行失败，状态：${contingency_plan_params}，参数：params: ${contingency_plan_params}
  * 样例：自愈预案 在 OBServer 进程异常退出时重新拉起 id: 41005 执行失败，状态：${status}，参数：{"ob_server_id":"19","ob_cluster_id":"19","svr_ip":"xxx.xxx.xxx.xxx","host_id":"12"}。
