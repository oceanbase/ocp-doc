...
|  参数   |          值           |
|-------|----------------|
| 监控指标  | tp_service_exist、ntp_service_available         |
...
**监控指标** tp_service_exist 的值为时钟服务是否存在的检查结果，为 1 时表示存在，为 0 时表示不存在。为 0 时，触发告警。

//ntp_service_available

## 规则信息

|          监控指标          | 默认阈值 | 持续时间 | 检测周期 | 消除周期 |
|------------------------|------|------|------|------|
| <li>tp_service_exist</li><li>ntp_service_available</li> | <li>ntp_service_available：0</li><li>tp_service_exist：0</li>    | 0 秒   | 10 秒 | 5 分钟 |
