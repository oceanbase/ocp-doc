...
* **告警概述**
  ...
  * 样例：svr_ip=xxx.xxx.xxx.xxx 服务器 CPU 使用率超限
...
* **告警恢复**
  ...
  * 模板：告警：${alarm_name}，服务器 CPU 使用率：user、system、nice、irq、softirq、steal 之和：\${cpu_used_percent_value_zh_cn}，服务器 CPU steal 使用率：\${cpu_steal_value_zh_cn}
  * 样例：告警：服务器 CPU 使用率超限，服务器 CPU 使用率：user、system、nice、irq、softirq、steal 之和：80 %，服务器 CPU steal 使用率：30 %
