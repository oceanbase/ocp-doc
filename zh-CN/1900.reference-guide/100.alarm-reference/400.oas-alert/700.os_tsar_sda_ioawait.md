# os_tsar_sda_ioawait OceanBase server 服务器磁盘 ioawait 过高
...
* **告警概述**
  ...
  * 样例：ob_cluster=obcluster-1631964370:svr_ip=xxx.xxx.xxx.xxx:device=dm-0 OceanBase server 服务器磁盘 ioawait 过高
* **告警详情**
  * 模板：集群：\${ob_cluster_name}，主机：\${host}，告警：\${alarm_name}。OceanBase 磁盘：\${ob_device}，device \${device}，io await \${io_await_value_zh_cn} 超过 \${io_await_alarm_threshold} ms，io util \${io_util_value_zh_cn} 超过 ${io_util_alarm_threshold} %。
  * 样例：集群：obcluster-1，主机：xxx.xxx.xxx.xxx，告警：OceanBase server 服务器磁盘 ioawait 过高。OceanBase 磁盘：ob_log，device dm-0，io await 300 毫秒 超过 200 毫秒，io util 99.1 % 超过 99 %。
* **告警恢复**
  * 模板：告警：${alarm_name}，OBServer 磁盘 io_await：\${io_await_value_zh_cn}，OBServer 磁盘 io_util：\${io_util_value_zh_cn}
  * 样例：告警：OceanBase server 服务器磁盘 ioawait 过高，OBServer 磁盘 io_await：120 毫秒，OBServer 磁盘 io_util：85 %
