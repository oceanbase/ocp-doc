...
* **告警恢复**
  ...
  * 模板：告警：${alarm_name}，服务器每个 CPU softirq（软中断）使用率：\${cpu_softirq_per_cpu_value_zh_cn}，服务器每个 CPU 空闲率：\${cpu_idle_per_cpu_value_zh_cn}
  * 样例：告警：服务器 CPU 软中断未打散，服务器每个 CPU softirq（软中断）使用率：1 %，服务器每个 CPU 空闲率：8 %
