...
* **告警详情**
  ...
  * 样例：集群：obcluster-1，主机：xxx.xxx.xxx.xxx，告警：服务器 inode 使用率过高。inode 使用率 95 % 超过 80 %。

* **告警恢复**

  * 模板：告警：${alarm_name}，服务器 inode 使用率：\${value_shown}
  * 样例：告警：服务器 inode 使用率过高，服务器 inode 使用率：60 %
