...
* **告警恢复**
  ...
  * 模板：告警：${alarm_name}，服务器 CPU 使用率：user、system、nice、irq、softirq、steal 之和：\${value_shown}
  * 样例：告警：服务器 CPU 使用率爆满，服务器 CPU 使用率：user、system、nice、irq、softirq、steal 之和：90 %
