# os_kernel_io_hang OceanBase server 服务器 IO Hang
...
* **告警概述**
  ...
  * 样例：ob_cluster=obcluster-1631964370:svr_ip=xxx.xxx.xxx.xxx:device=dm-1 OceanBase server 服务器 IO Hang
* **告警详情**
  * 模板：集群：\${ob_cluster_name}，主机：\${host}，告警：\${alarm_name}。OceanBase 磁盘：\${ob_device}，device ${device}，io util \${io_util_value_zh_cn} 超过 \${io_util_alarm_threshold} %，io qusize \${io_qusize_value} 超过 \${io_qusize_alarm_threshold}
  * 样例：集群：obcluster-1，主机：xxx.xxx.xxx.xxx，告警：OceanBase server 服务器 IO Hang。OceanBase 磁盘：ob_data，device dm-1，io util 99.1 % 超过 99 %，io qusize 30 超过 20
* **告警恢复**
  * 模板：告警：${alarm_name}，OBServer 磁盘 io_util：\${io_util_value_zh_cn}，OBServer 磁盘 io_qusize：\${io_qusize_value}，OBServer 磁盘 IO 平均读写时间之和：\${recover_value}
  * 样例：告警：OceanBase server 服务器 IO Hang，OBServer 磁盘 io_util：80 %，OBServer 磁盘 io_qusize：15，OBServer 磁盘 IO 平均读写时间之和：5 秒
