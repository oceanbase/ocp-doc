...
| --- | --- | --- | --- | --- |
| observer_core_dump_seconds  | observer_core_dump_seconds < 1200 and observer_core_dump_seconds > 0 | 0 秒 | 10 秒 | 5 分钟 |
...
* **告警概述**
  ...
  * 样例：ob_cluster=obcluster-1631964370:svr_ip=xxx.xxx.xxx.xxx OceanBase server Core Dump

* **告警详情**

  * 模板：集群：\${ob_cluster_name}，主机：\${host}，告警：\${value_shown} 前 OceanBase server Core Dump。
  * 样例：集群：obcluster-1，主机：xxx.xxx.xxx.xxx，告警：10 分钟前 OceanBase server Core Dump。

* **告警恢复**

  * 模板：告警：${alarm_name}，距 OBServer 最近 Core Dump 时长：\${value_shown}
  * 样例：告警：OceanBase server Core Dump，距 OBServer 最近 Core Dump 时长：0 秒
