...
|   参数    |    类型     | 必选 |  示例值  |          描述      |
|-----------|-------------|------|----------|-----------------------|
| id        | Integer     | 是   |   1000002      | OCP 侧的集群 ID。      |
...
| status    | StringArray | 否  | CREATING | 租户的状态：<li>NORMAL：运行中。</li><li>CREATING：创建中。</li><li>MODIFYING：修改中。</li><li>UNAVAILABLE：不可用。</li><li>OPERATING：运维中。</li><li>CLONING：克隆中。</li><li>RESTORING：恢复中。</li><li>DISCONNECTING：解耦中。</li><li>FAILOVER：容灾切换。</li><li>SWITCHOVER：日常切换。</li><li>TDE_ENABLING：TDE 加密中。</li>    |
