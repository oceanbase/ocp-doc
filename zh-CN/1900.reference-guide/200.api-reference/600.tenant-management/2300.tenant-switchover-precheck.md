...
| 参数 | 类型    | 必选 | 示例值 | 描述           |
|------|---------|------|--------|-----------------|
| id   | Integer | 是   | 3000009   | 主租户所属集群在 OCP 端的集群 ID。 |
| tenantId |  Integer | 是   | 2000022      | 主租户在 OCP 端的租户 ID。 |

**body：**

| 参数  |  类型  |  必选  | 示例值  |  描述  |
|-------|--------|---------|---------|---------|
| tenantId  |  Long  |  是  |  2000022  | 主租户在 OCP 端的租户 ID。 |
| standbyTenantId | Long | 是 | 2000025 | 备租户在 OCP 端的租户 ID。 |
