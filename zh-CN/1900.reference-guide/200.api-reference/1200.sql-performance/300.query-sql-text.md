...
`GET /api/v2/ob/clusters/{id}/tenants/{tenantId}/sqls/{sqlId}/text`
...
| statement      | String   | SQL 参数化后的文本。         |
| supportOutline      | Boolean   | SQL 是否能绑定 outline, OBServer V2.2.70 以下的版本要求 select 后第一个字符必须为空格。         |
| tables      | String   | SQL 里的表名。         |
