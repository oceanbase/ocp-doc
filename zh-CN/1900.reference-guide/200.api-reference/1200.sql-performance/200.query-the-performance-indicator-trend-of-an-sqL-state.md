...
| tenantId  | Integer  | 是  | 1001                             | 租户 ID。                                                |
| sqlId     | String   | 是  | C9B3A63AFF8F2A408CCF3D5B0F36682D | SQL ID。                                              |
...
| avgLogicalReads          | Double    | SQL 的平均逻辑读次数                    |
| dbName          | String    | 数据库名称                    |
| missPlans          | Integer    | 期间内的未命中计划数                    |
| remotePlans          | Integer    | 期间内的远程计划数                    |
| server          | String    | SQL 执行所在的 Server                    |
| serverIp          | String    | SQL 执行所在的 Server 的 IP                    |
...
| userName          | String    | SQL 的用户                    |
| waitEvent          | String    | 期间内的最长等待事件                    |
