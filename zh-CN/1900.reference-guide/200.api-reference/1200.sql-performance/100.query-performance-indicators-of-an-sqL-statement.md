...
**<UI-TERM key="ocp-v2.Information.Detail.CollectDetails.Description">说明</UI-TERM>**
...
* SQL 性能指标的数据结构
  ...
  **<UI-TERM key="ocp-v2.Detail.Component.ModifyParameterDrawer.Description">说明</UI-TERM>**
