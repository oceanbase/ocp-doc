...
完整的 HTTP 请求包括 **请求 URI** 、 **<UI-TERM key="ocp-v2.Alarm.Channel.Detail.RequestMethod">请求方法</UI-TERM>** 、 **请求消息头** 、 **请求消息体** 。
...
* AK/SK 认证模式
   ...
   详情可参考 [AK/SK 签名生成规则](../200.api-reference/300.ak-sk-sign-roles.md)。
