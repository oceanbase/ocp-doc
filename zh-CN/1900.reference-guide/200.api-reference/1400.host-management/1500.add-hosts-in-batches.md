...
| kind              | String      | 是  | DEDICATED_PHYSICAL_MACHINE | 主机类型，有如下两种：<li>DEDICATED_PHYSICAL_MACHINE：物理机。</li><li>DEDICATED_ECS：ECS。</li>    |
| idcId             | Long        | 是  | 100                        | 机房 ID。 |
| typeId            | Long        | 是  | 1001                       | 机型 ID。   |
| credentialId      | Long        | 是  | 1001                       | 凭据 ID，凭据是 SSH 用来访问主机的信息。   |
| alias             | String      | 否  | 机器1                      | 主机的别名，只有添加单台时才可以设置别名。  |
...
| operation        | String      | 任务操作，有如下区域操作：<li>EXECUTE：正常执行。</li><li>RETRY：重试。</li><li>ROLLBACK：回滚。</li><li>SKIP：跳过。</li><li>CANCEL：取消。</li>    |
...
| operation        | String    | 子任务操作，有如下区域操作：<li>EXECUTE：正常执行。</li><li>RETRY：重试。</li><li>ROLLBACK：回滚。</li><li>SKIP：跳过。</li><li>CANCEL：取消。</li>    |
...
| prohibitRollback | Boolean   | 子任务是否禁止回滚。         |
