...
1. 获取 AK/SK。
    ...
    前往您的 OCP 管控台，单击右上角 **<UI-TERM key="ocp-v2.page.Settings.Profile.PersonalSettings">个人设置</UI-TERM>** ，在页面中选择 **一键创建 AccessKey**。
...
2. 将光标悬停于右上角用户名上，在弹出的菜单栏中单击 **<UI-TERM key="ocp-v2.page.Settings.Profile.PersonalSettings">个人设置</UI-TERM>**。

3. 进入 **<UI-TERM key="ocp-v2.page.Settings.Profile.PersonalSettings">个人设置</UI-TERM>** 页面，在 **AccessKey** 模块单击 **一键创建 AccessKey**，详情可参考 [设置个人信息](../../1600.system-management-features/700.manage-user-center/100.configure-personal-information.md)。
