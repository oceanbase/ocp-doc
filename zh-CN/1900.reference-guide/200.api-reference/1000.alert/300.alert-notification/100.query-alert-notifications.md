...
|------------------|----------|-----------------------|
| data             | Object   | 请求的数据。                |
| ├─ contents      | Array    | 告警通知的列表，详情参见 **告警通知数据结构**。 |
| ├─ page          | Object   | 分页信息。                 |
...
| obregion_group   | String                 | OBserver 集群组别名，兼容现有 OCP。                            |
| obregion         | String                 | OBserver 集群别名，兼容现有 OCP。                            |
| tenant_name      | String                 | OBserver 租户别名，兼容现有 OCP。                            |
| host_name        | String                 | 主机名。                                                |
| host_ip          | String                 | 主机 IP。                                                |
| svr_ip           | String                 | 主机 IP 别名，兼容现有 OCP。                                   |
