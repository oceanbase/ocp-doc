...
| mode             | String  | 否  | MYSQL              | 租户兼容模式，取值范围：MYSQL   |
| primaryZone      | String  | 否  | zone1,zone2;zone3  | Zone 优先级                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| charset          | String  | 否  | utf8mb4            | 字符集，取值范围：<ul><li>binary   </li><li>utf8mb4    </li><li>gbk   </li><li>gb18030  </li></ul>缺省为 utf8mb4     |
| collation        | String  | 否  | utf8mb4_general_ci | 校验规则，取值范围： <ul><li>binary   </li><li> utf8mb4   </li><li>gbk  </li><li> gb18030  </li></ul> 缺省为 utf8mb4_general_ci |
...
| rootPassword     | String  | 是  |                    | 管理员用户密码。 MYSQL 租户：root 用户 </li><li>密码强度说明： 长度为 8 \~ 32，且至少包含 2 个数字、2 个大写字母、2 个小写字母和 2 个特殊字符，支持的特殊字符为 ._+@#$% </li>                                                                                                                                                                                                                                                                                                                      |
...
| clusterType | String   | 集群类型，取值范围： PRIMARY：主集群  |
| mode        | String   | 租户兼容模式，取值范围：  MYSQL            |
