...
|    参数    |  类型  | 必选 | 示例值 |  描述   |
|----------|------|-------|------|-------|
| id       | Long | 是  | 20   | 目标租户所属集群在 OCP 端的集群 ID。 |
| tenantId | Long | 是  | 3    | 目标租户在 OCP 端的租户 ID。 |
...
| replicaType    | String  | 否  | FULL | 副本类型，取值范围：<li>FULL</li><li>LOGONLY</li><li>READONLY</li><li>COLUMNSTORE</li>   |
| resourcePool   | Object  | 否  | --   | 资源池信息。     |
...
|     参数     |    类型    |                                         说明                                          |
|------------|----------|-------------------------------------------------------------------------------------|
| data       | Object   | 创建成功的租户信息，异步 DAG 任务信息，详情参见 [任务信息](../400.task-return-structure.md)。 |
