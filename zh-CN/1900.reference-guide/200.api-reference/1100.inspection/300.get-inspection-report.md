...
|--------|--------|----------------------------------|
|  data        |  Object   | 请求的数据。 |
|  ├─ contents |  Array    | 详情参见 **InspectionReport 数据结构**。    |
...
**InspectionReport 数据结构**

|  参数  |  类型  |  说明  |
|--------|--------|--------|
|  id  |  Integer  |  巡检报告 ID，获取方式可参见 [查询所有巡检任务](100.get-all-inspection-task.md) 接口。  |
|  tag  |  InspectionTag  |  详情参见 **InspectionTag 数据结构**。  |
|  inspectionObject  |  InspectionObject  |  详情参见 **InspectionObject 数据结构**。  |
...
|  inspectionItems  |  Array  |  巡检报告中包含的所有巡检项的信息，详情参见 **InspectionItemOverview 数据结构**。  |
|  reportItems  |  Array  |  所有巡检项条目，详情参见 **InspectionReportItem 数据结构**。  |
...
**InspectionItemOverview 数据结构**

|  参数  |  类型  |  说明  |
|--------|--------|--------|
|  id          |  Integer  |  巡检项 ID。  |
|  identifier  |  Integer  |  巡检项唯一标识符。  |
|  name        |  String   |  巡检项名称。  |
|  description |  String   |  巡检项描述。  |
|  targetType  |  String   |  巡检项类型。  |
...
|  参数  |  类型  |  说明  |
|--------|--------|--------|
|  itemId    |  Integer  |  巡检项 ID。  |
|  rawValue  |  String   |  未经加工的巡检结果值。  |
|  value     |  String   |  巡检结果值。  |
|  target    |  String   |  巡检目标。  |
|  key       |  String   |  巡检结果键。  |
|  level     |  Array    |  巡检结果等级。  |
