...
| ├─ kind         | String  | 否  | DEDICATED_PHYSICAL_MACHINE | 主机类型，取值范围： DEDICATED_PHYSICAL_MACHINE、DEDICATED_ECS 或 DEDICATED_CONTAINER，默认为 DEDICATED_PHYSICAL_MACHINE。 |
...
| ├─ sshPort      | Integer | 否  | 22               | 主机 SSH 端口，默认为 22。 |
