...
| ├─ kind         | String  | 否  | DEDICATED_PHYSICAL_MACHINE | 主机类型，物理机或容器。可选值为 DEDICATED_PHYSICAL_MACHINE、DEDICATED_CONTAINER 或 DEDICATED_ECS，默认为 DEDICATED_PHYSICAL_MACHINE。 |
