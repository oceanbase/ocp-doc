...
| servers      | Object   | 详情参见 **<UI-TERM key="ocp-v2.Component.UpgradeDistributedClusterDrawer.ObserverInformation">OBServer 信息</UI-TERM>**。                                         |
...
| kind                      | String    | 主机类型，有如下三种：<li>DEDICATED_PHYSICAL_MACHINE：物理机</li><li>DEDICATED_CONTAINER：容器</li><li>DEDICATED_ECS：ECS</li>  |
| name                      | String    | 主机名。   |
