...
|     参数     |    类型    |          说明           |
|------------|----------|-----------------------|
| data       | Array    | ClusterParameter 列表，详情参见下表。   |
...
| valueRange   | Object  | ValueRange 数据结构，详情参见下表。            |
| currentValue | Object  | ClusterParameterValue 数据结构，详情参见下表。 |
...
| obParameters   | Array | ObParameter 数据结构，详情参见下表。 |
