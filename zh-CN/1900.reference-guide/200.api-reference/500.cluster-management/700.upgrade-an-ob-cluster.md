...
<<<<<<< HEAD:zh-CN/1900.reference-guide/200.api-reference/500.cluster-management/700.upgrade-an-ob-cluster.md
=======
### 请求参数

>>>>>>> 2db3a313 (1):zh-CN/1900.reference-guide/200.api-reference/450.cluster-information/700.upgrade-an-ob-cluster.md
**path：**
...
|     参数        |   类型  | 必选  |     示例值     |   描述    |
|-----------------|---------|-------|---------------|---------|
| rpmFileName     | String  | 是    | -             | 已废弃，后续版本中将删除该参数。 |
| upgradeMode     | Enum    | 是    | ROLLING       | 升级模式，默认为轮转升级。取值范围：<li>ROLLING：轮转升级。</li><li>ORDINARY：一般升级（可能停服）。</li> |
| destVersion     | String  | 是    | 2.2.77-202204041221 | 目标版本。 |
| operatingSystem | String  | 是    | el7           | 操作系统。 |
| freezeServer    | Boolean | 否    | false         | 停止 Server 前是否需要转储。 |
| zoneOrder       | Array   | 否    | [zone1,zone2] | 升级主集群时，Zone 的升级顺序。 |
=======
| id | Long | 是  | 1   | 待升级的 OceanBase 集群 ID。 |
