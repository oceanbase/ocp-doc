...
* 告警概述样例：ocp_ip=xxx.xxx.xxx.xxx:obproxy_address=192.168.0.2:obproxy_port=2888 系统 OBProxy 不可用

* 告警详情样例：主机：xxx.xxx.xxx.xxx，告警：系统 OBProxy（192.168.0.2:obproxy_port=2888）不可用
