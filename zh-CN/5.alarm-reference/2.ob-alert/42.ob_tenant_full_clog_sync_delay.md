...
2. 查看主机网络、负载等运维指标，确定问题原因并排查故障。
   ...
   * 负载等运维指标查看：
     ...
     4. 选择 **监控** 页签。
        ...
        如果负载稳步趋于过高的水平，可为该 OceanBase 集群 [添加 OBServer](../../6.user-guide-2/4.cluster-features/2.basic-operations/7.manage-observer/1.add-an-observer.md)，分担当前 OBServer 的负载。
