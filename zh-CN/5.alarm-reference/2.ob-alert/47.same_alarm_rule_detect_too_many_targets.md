...
* [ob_tenant_slow_sql_exists 慢 SQL 告警](45.ob_tenant_slow_sql_exists.md)

* [ob_tenant_large_trans_exist OB 租户存在大事务](46.ob_tenant_large_trans_exist.md)

* [ob_tenant_long_trans_exist OB 租户存在长事务](51.ob_tenant_long_trans_exist.md)

* [ob_tenant_expired_trans_exist OB 租户存在悬挂事务](50.ob_tenant_expired_trans_exist.md)
