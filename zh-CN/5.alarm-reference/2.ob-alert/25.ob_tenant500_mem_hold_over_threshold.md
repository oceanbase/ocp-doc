...
* 告警概述样例：ob_cluster=obcluster-1:svr_ip=192.168.0.1 OB 500 租户的占用内存大小超限

* 告警详情样例：集群：obcluster-1，主机：192.168.0.1，告警：OB 500 租户的占用内存大小超限，占用内存 101.0 GB， 超过 100.0 GB
