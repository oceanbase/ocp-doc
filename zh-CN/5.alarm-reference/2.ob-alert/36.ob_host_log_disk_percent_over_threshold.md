...
* 告警概述样例：ob_cluster=obcluster-1:svr_ip=192.168.0.1 OB 主机日志目录磁盘使用率超限

* 告警详情样例：集群：obcluster-1，主机：192.168.0.1，告警：OB 主机日志目录磁盘使用率超限，日志目录 /data/log1 挂载点 /data/log1 磁盘使用率 98.0 % 超过 85.0 %
