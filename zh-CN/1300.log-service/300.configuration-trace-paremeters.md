...
* 日志服务 **<UI-TERM key="ocp-v2.Auth.Role.All">全部</UI-TERM>** 菜单权限。
...
3. 单击 **<UI-TERM key="ocp-v2.Log.Trace.LinkQuery">链路查询</UI-TERM>** 页签。
4. 在系统提示中单击 **<UI-TERM key="ocp-v2.Log.Trace.ModifySystemParameters">修改系统参数</UI-TERM>** 按钮，进入 **<UI-TERM key="ocp-v2.src.util.menu.SystemParameters">系统参数</UI-TERM>** 页面。
