...
* 请确保当前登录 OCP 的用户具备如下权限：
  ...
  * 日志服务 **<UI-TERM key="ocp-v2.component.alarm.RuleDetail.All">全部</UI-TERM>** 菜单权限。
...
3. 单击 **<UI-TERM key="ocp-v2.page.Log.LinkQuery">链路查询</UI-TERM>** 页签，进入 **<UI-TERM key="ocp-v2.Component.SQLTable.LinkQuery">链路查询</UI-TERM>** 界面。
4. 可通过在 **<UI-TERM key="ocp-v2.Log.Trace.LinkQuery">链路查询</UI-TERM>** 界面中设置查询条件，辅助定位目标 Trace。
...
5. 单击 **<UI-TERM key="ocp-v2.Detail.SQLDiagnosis.Query">查询</UI-TERM>** 按钮。
