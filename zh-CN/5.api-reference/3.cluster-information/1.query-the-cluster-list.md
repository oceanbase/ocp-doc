...
| status      | StringArray | 否  | CREATING,RUNNING | 集群的状态。 取值范围：</br>RUNNING：运行中。</br>CREATING：创建中。  </br>DELETING：删除中。</br>STARTING：启动中。 </br>RESTARTING：重启中。</br>STOPPING：停止中。</br>STOPPED：已停止。</br>TAKINGOVER：接管中。 </br>MOVINGOUT：迁出中。</br>SWITCHOVER：主备集群切换中。 </br>FAILOVER：备集群故障恢复中。</br>OPERATING 运维中。    |
