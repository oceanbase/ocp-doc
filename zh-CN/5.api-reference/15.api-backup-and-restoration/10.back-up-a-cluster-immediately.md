...
| obBackupServiceStorageConfig | Object | 是  | NA             | 备份存储配置，参见 [创建集群的备份策略](/zh-CN/5.api-reference/15.api-backup-and-restoration/2.create-a-backup-policy-for-the-cluster.md) 中的具体数据结构。                                                                                                     |
