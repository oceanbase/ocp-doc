...
| obBackupServiceStorageConfig    | Object | 备份存储配置，参见 [创建集群的备份策略](/zh-CN/5.api-reference/15.api-backup-and-restoration/2.create-a-backup-policy-for-the-cluster.md) 中的 **ObBackupServiceStorageConfig 的数据结构** 。 |
| backupMode      | String | 备份恢复方式，支持 **LOGICAL_BACKUP、**  **PHYSICAL_BACKUP** 两种。                                         |
| serviceConfigName               | String | 服务配置名。                                                                                                         |
| obBackupScheduleConfig          | Object | 备份调度配置，参见 [创建集群的备份策略](/zh-CN/5.api-reference/15.api-backup-and-restoration/2.create-a-backup-policy-for-the-cluster.md) 中的 **obBackupScheduleConfig 的数据结构** 。       |
