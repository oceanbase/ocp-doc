...
| appType          | String   | 否    | OB                            | 应用类别（告警来源），取值范围： <li> OB  </li>  <li> OCP   </li>  <li> OMS  </li>  <li> OBProxy  </li>  <li> Backup </li>               |
| alarmType        | String   | 否    | obagent_dead                  | 告警类型。参考 OCP 相关文档。                                                                                                                                                                                                                                                                |
| scope            | String   | 否    | ObCluster                     | 告警范围，取值范围：<li>ObCluster   </li>  <li>ObTenant  </li>  <li>AppCluster  </li>  <li>Service  </li>  <li> Host </li>    |
...
| category         | String   | 否    | OB                            | 告警大类，取值范围： <li> OB  </li>  <li> APP </li>                                                                                                                                                      |
...
* 告警事件的数据结构
  ...
  |-------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  | id          | Integer  | 告警事件的 Id。                                                                                                                                                                                                                                                                        |
  | appType     | String   | 应用类型，取值范围： <li> OB  </li>  <li> OCP  </li>  <li> OMS </li>  <li> OBProxy </li>  <li> Backup  </li>                   |
  | alarmType   | String   | 告警类型                                                                                                                                                                                                                                                                             |
  | scope       | String   | 告警范围，取值范围： <li> ObCluster  </li>  <li>ObTenant  </li>  <li> AppCluster  </li>  <li> Service  </li>  <li> Host </li>  |
