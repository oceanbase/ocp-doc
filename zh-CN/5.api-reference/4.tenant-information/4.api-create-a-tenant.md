...
| whitelist        | String  | 否  | %                  | 支持的格式有： IP地址，示例：10.10.10.10,10.10.10.11 子网/掩码，示例：10.10.10.0/24 模糊匹配，示例：10.10.10.% 或 10.10.10._ 多种格式混合，示例：10.10.10.10,10.10.10.11,10.10.10.%,10.10.10._,10.10.10.0/24 特殊说明：% 表示所有客户端都可以连接 缺省为%                                                                                                                                                                                                              |
