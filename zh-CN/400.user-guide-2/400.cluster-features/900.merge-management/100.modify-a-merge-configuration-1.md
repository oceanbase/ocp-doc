...
集群级别设置的策略将对集群内所有的租户生效，适用于需要对集群内所有租户的合并配置进行统一管理的场景。若您需要对单个租户设置不同的合并策略和转储策略，您可参考 [修改租户合并配置](../../500.tenant-functions/1100.merge-management/100.manage-merge-configuration.md) 进行个性化配置。
...
4. 单击 **合并配置** 页签。
  ...
  <main id="notice" type='explain'>
   ...
   ![09161958](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/ocp/403-ce/%E9%9B%86%E7%BE%A4%E5%90%88%E5%B9%B6%E9%85%8D%E7%BD%AE.png)
