...
您可在 **OCP Agent** 页签查看 OCP Agent 的状态、安装目录、安装时间、版本、日志目录和最近可用时间。同时也可查看详细的进程列表，并进行进程管理操作，详情参见 [下载日志](../../400.cluster-features/200.basic-operations/1000.download-log.md)、[重启 OCP Agent](../../600.host-features/400.restart-the-ocp-agent.md)。
