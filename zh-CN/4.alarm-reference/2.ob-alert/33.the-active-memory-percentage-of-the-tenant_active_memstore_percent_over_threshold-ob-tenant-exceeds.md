...
* 排查转储或合并是否存在异常，
  ...
  这类异常通常可以通过重启 OBServer 恢复，重启 OBServer 可参考 [重启 OBServer](/zh-CN/3.ob-cloud-platform/4.manage-clusters/3.basic-operations/8.manage-the-observer-cluste/3.cluster-restart-observer.md) 。
