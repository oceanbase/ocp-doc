...
* 删除不需要使用的租户 。
  ...
  删除方法请参见 [删除租户](/zh-CN/3.ob-cloud-platform/5.manage-tenants/2.basic-tenant-operations/7.userguide-delete-a-tenant.md)。
...
* 集群扩容。
  ...
  为该 OceanBase 集群增加 OBServer，方法请参见 [添加 OBServer](/zh-CN/3.ob-cloud-platform/4.manage-clusters/3.basic-operations/8.manage-the-observer-cluster/1.cluster-add-observer.md)。
