...
2. 查看 OCP 告警界面是否有如下告警或其他数据盘相关的告警上报。
   ...
   [ob_server_sstable_percent_over_threshold OB 服务器数据盘使用率超限](/zh-CN/4.alarm-reference/2.ob-alert/27.ob_server_sstable_percent_over_threshold-the-data-disk-usage-of-the-ob-server-exceeds.md)

   [ob_zone_sstable_percent_over_threshold OB 集群 Zone 数据盘使用率超限](/zh-CN/4.alarm-reference/2.ob-alert/32.ob_zone_sstable_percent_over_threshold-the-partition-usage-of-data-disks-for-ob-clusters.md)
