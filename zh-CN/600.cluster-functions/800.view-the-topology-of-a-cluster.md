...
在集群 **<UI-TERM key="ocp-v2.src.util.menu.TopologicalGraph">拓扑图</UI-TERM>** 页面，针对不同的操作，要求用户需具备的权限有所不同：
...
* **查看拓扑图信息**
  ...
  * **集群只读** 资源权限。
  * 集群 **<UI-TERM key="ocp-v2.src.util.menu.TopologicalGraph">拓扑图</UI-TERM>** 菜单权限。
...
3. 在 **<UI-TERM key="ocp-v2.page.Cluster.ClusterList">集群列表</UI-TERM>** 中选择待操作的集群并单击其集群名，进入集群 **<UI-TERM key="ocp-v2.src.hook.useMenu.Overview">概览</UI-TERM>** 页面。

4. 在显示的页面的左侧导航栏上，单击 **<UI-TERM key="ocp-v2.src.util.menu.TopologicalGraph">拓扑图</UI-TERM>** ，进入集群拓扑图页面。
