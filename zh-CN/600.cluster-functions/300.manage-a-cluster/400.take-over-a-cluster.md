...
5. 单击 **提交**。
   ...
   任务提交后，您可在提交结果页面查看任务执行进度或返回集群概览页面。
    ...
    <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>由于 OCP 连接数据库需要在凭据管理中有对应的凭据串存在，当接管集群完成后，您可将 <a href="650.move-out-a-cluster.md">导出集群</a> 时获取的集群凭据文件导入此 OCP 中，方便您批量上传集群的凭据信息，具体操作详情可参见 <a href="../../1600.system-management-features/700.manage-password-box/300.import-connection.md">导入凭据</a>。</p>
    </main>
