...
* 若待接管的 OceanBase 集群已配置仲裁服务，在执行接管前，请先迁出该仲裁服务并将其接管到新 OCP 中，详情可参考 [迁出仲裁服务](../400.manage-arbitration-services/650.migrate-an-arbitration-service.md)、[接管仲裁服务](../400.manage-arbitration-services/250.take-over-arbitration-serveices.md)。
