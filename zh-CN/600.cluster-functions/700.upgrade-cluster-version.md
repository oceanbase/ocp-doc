...
* 若集群下租户存在主备关系：
  * 当主租户关联的备租户所在集群低于当前集群版本时，为避免主备租户数据同步异常，请您优先升级备租户所在集群，或执行 <a href="../1200.manage-disaster-recovery/100.daily-active-standby-tenant-switchover.md">租户日常切换</a> 操作切换集群下的主备租户角色。
