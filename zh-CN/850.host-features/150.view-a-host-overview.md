...
* **详情** 中支持查看 OCP Agent 状态、安装目录、安装时间、版本、日志目录和最近可用时间。

* **进程列表** 支持查看详细的进程信息，包括进程 ID、名称、启动命令、操作系统用户、端口号、规格、已运行时间、最近可用时间、状态等。

  * 单击操作列的 **下载日志**，可下载当前进程的日志信息。

  * 单击 `ocp_monagent` 进程操作列的 **变更规格**，可为当前主机变更 OCP Agent 规格。
