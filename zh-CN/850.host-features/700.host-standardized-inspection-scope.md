...
<h4>说明</h4>
<p><li><b>主机标准化检查</b> 目前仅适用于部署 OBServer 的机器，其他机器场景请酌情使用。</li><li>容器环境下，由于 cgroup、namespace 等限制可能无法检查或者自动修复，建议参考文档内容手动按需酌情操作。</li></p>
</main>
...
|  Debian        | 10 及以上 | x86_64（包括海光），ARM_64（仅支持鲲鹏、飞腾）|
