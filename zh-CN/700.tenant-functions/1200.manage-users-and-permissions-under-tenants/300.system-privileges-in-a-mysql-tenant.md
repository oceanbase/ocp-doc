|slug|system-privileges-in-a-mysql-tenant|
|---|---|
...
|     **<UI-TERM key="ocp-v2.Auth.Role.Detail.Permission">权限</UI-TERM>**     |                          **<UI-TERM key="ocp-v2.component.alarm.RuleDetail.Description">说明</UI-TERM>**                           |
|----------------|-----------------------------------------------------------|
