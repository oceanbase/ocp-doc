...
发生灾容切换后，主备列表中的 OCP 便不会再向原主 OCP 集群汇报心跳，因此原主 OCP 的 **<UI-TERM key="ocp-v2.MultiCluster.Detail.ActiveStandbyList">主备列表</UI-TERM>** 中会存在心跳检测异常的 OCP。 此时原主 OCP 中仍残留其他 OCP 信息。
...
* 当前 OCP 的 **<UI-TERM key="ocp-v2.MultiCluster.Detail.ActiveStandbyList">主备列表</UI-TERM>** 中存在心跳异常的 OCP 集群。且集群满足如下条件：
...
4. 在 **<UI-TERM key="ocp-v2.MultiCluster.Detail.ActiveStandbyList">主备列表</UI-TERM>** 中找到需要删除的 OCP ，并单击其后的 **<UI-TERM key="ocp-v2.User.Component.DeleteUserModal.Delete">删除</UI-TERM>** 按钮。
...
5. 单击 **<UI-TERM key="ocp-v2.Backup.BackupStrategy.Detail.Delete">删除</UI-TERM>** 。

   提示 **<UI-TERM key="ocp-v2.MultiCluster.Detail.TheSecondaryOcpIsDeleted">备 OCP 删除成功</UI-TERM>** 。
