|slug|ob_cpu_assigned_percent_over_threshold|
|---|---|
...
* 删除不需要使用的租户 。
  ...
  删除方法请参见 [删除租户](../../400.user-guide-2/500.tenant-functions/200.manage-basic-tenant-operations/500.delete-a-tenant.md)。
