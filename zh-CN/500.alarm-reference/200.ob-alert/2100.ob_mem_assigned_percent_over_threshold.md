...
2. 可能是 OceanBase 集群的剩余内存不足。
   ...
   可根据实际情况，选择下述方法解决。
   1. 参考 [删除租户](../../400.user-guide-2/500.tenant-functions/200.manage-basic-tenant-operations/600.delete-a-tenant.md) 删除不使用的租户 。
   ...
   3. 参考 [添加 OBServer 节点](../../400.user-guide-2/400.cluster-features/200.basic-operations/700.manage-observer/100.add-an-observer.md) 为该集群增加 OBServer 节点从而达到集群扩容的目的。
