...
| whitelist        | String  | 否  | %                  | 支持的格式有： IP地址，示例：xxx.xxx.xxx.xxx,xxx.xxx.xxx.xxx 子网/掩码，示例：xxx.xxx.xxx.xxx/24 模糊匹配，示例：10.10.10.% 或 10.10.10._ 多种格式混合，示例：xxx.xxx.xxx.xxx,xxx.xxx.xxx.xxx,10.10.10.%,10.10.10._,xxx.xxx.xxx.xxx/24 特殊说明：% 表示所有客户端都可以连接 缺省为%                                                                                                                                                                                                              |
