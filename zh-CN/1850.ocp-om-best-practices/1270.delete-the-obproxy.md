...
4. 在 OBProxy 列表中选择需要删除的 OBProxy，单击 **<UI-TERM key="ocp-v2.Oracle.UserOrRoleDetail.Operation">操作</UI-TERM>** 列的 **<UI-TERM key="ocp-v2.page.Host.Delete">删除</UI-TERM>** 。

   ![1634](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/ocp/422/%E5%88%A0%E9%99%A4obproxy.png)

   您也可勾选多个 OBProxy，在 **<UI-TERM key="ocp-v2.src.util.component.More">更多</UI-TERM>** 中单击 **<UI-TERM key="ocp-v2.page.Package.BatchDelete">批量删除</UI-TERM>** 。
...
5. 在弹出的对话框中输入 **delete**，并单击 **<UI-TERM key="ocp-v2.component.ZoneFormCardList.Delete">删除</UI-TERM>** 。

6. 任务提交后，您可通过弹出框中的 **<UI-TERM key="ocp-v2.src.component.TaskLabel.ViewTasks">查看任务</UI-TERM>** 按钮，查看删除进度。
