...
* 请确保当前登录 OCP 的用户具备如下权限：
  ...
  * 告警中心 **<UI-TERM key="ocp-v2.component.common.ServerDropdown.All">全部</UI-TERM>** 菜单权限。
...
2. 在告警中心页面，单击 **<UI-TERM key="ocp-v2.Alarm.Channel.Detail.AlarmChannel">告警通道</UI-TERM>**。
...
6. 单击 **<UI-TERM key="ocp-v2.Detail.Parameter.List.Submitted">提交</UI-TERM>**，完成配置。
