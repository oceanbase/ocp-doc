...
2. 在左侧导航栏单击 **<UI-TERM key="ocp-v2.src.util.menu.SystemManagement">系统管理</UI-TERM>** > **<UI-TERM key="ocp-v2.page.Property.SystemParameters">系统参数</UI-TERM>**，确认以下三个系统参数的配置情况。
