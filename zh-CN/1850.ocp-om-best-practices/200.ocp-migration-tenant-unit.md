...
* **集群维护** 资源权限。
* 集群 **<UI-TERM key="ocp-v2.Detail.Resource.ResourceManagement">资源管理</UI-TERM>** 菜单权限。
...
1. 发起 Unit 迁移。
    ...
    进入 **<UI-TERM key="ocp-v2.Detail.Component.UpgradeModal.Cluster">集群</UI-TERM>** > **<UI-TERM key="ocp-v2.Detail.Resource.ResourceManagement">资源管理</UI-TERM>** > **<UI-TERM key="ocp-v2.Detail.Resource.UnitDistribution">Unit 分布</UI-TERM>** 页面，点击需要迁移的 Unit，在弹窗中选择迁移目的端。
...
2. 等待 Unit 迁移完成。
    ...
    **<UI-TERM key="ocp-v2.Detail.Resource.UnitDistribution">Unit 分布</UI-TERM>** 页面中会展示迁移中的 Unit。
