...
* 请确保当前登录 OCP 的用户具备如下权限：
  ...
  * 告警中心 **<UI-TERM key="ocp-v2.Auth.Role.Detail.All">全部</UI-TERM>** 菜单权限。
...
2. 在告警中心页面，单击 **<UI-TERM key="ocp-v2.Alarm.Subscriptions.New.AlarmChannel">告警通道</UI-TERM>**。

3. 在告警通道页签下，单击 **<UI-TERM key="ocp-v2.Alarm.Channel.NewChannel">新建通道</UI-TERM>**。
...
6. 单击 **<UI-TERM key="ocp-v2.Oracle.Component.RoleSelect.Submitted">提交</UI-TERM>**，完成配置。
...
A：首先通过 curl 测试是否能发送测试消息，如果网络不通，则需要在 **<UI-TERM key="ocp-v2.Alarm.Channel.NewChannel">新建通道</UI-TERM>** > **<UI-TERM key="ocp-v2.Alarm.Rule.New.BasicConfiguration">基本配置</UI-TERM>** > **<UI-TERM key="ocp-v2.Channel.FormComponent.WeComForm.Proxy">代理</UI-TERM>** 中配置网络代理。
