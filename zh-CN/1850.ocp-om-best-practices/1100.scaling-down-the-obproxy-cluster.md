...
2. 在左侧导航栏单击 **OBProxy**，并在集群列表中选择需要操作的 OBProxy 集群，进入集群 **<UI-TERM key="ocp-v2.Backup.Overview.Statistics.SummaryInvestingComZa">概览</UI-TERM>** 页面。

3. 在 OBProxy 列表中选择需要删除的 OBProxy Server，单击操作列的 **<UI-TERM key="ocp-v2.page.OBProxy.Delete">删除</UI-TERM>** 按钮；也可以勾选多个 OBProxy，单击 **<UI-TERM key="ocp-v2.Oracle.UserOrRoleDetail.BatchDelete">批量删除</UI-TERM>**。
