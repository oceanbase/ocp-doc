...
* 当前集群为备集群，且处于 **<UI-TERM key="ocp-v2.src.constant.compute.Running">运行中</UI-TERM>** 状态。
...
1. 登录备 OCP，单击左侧导航栏 **<UI-TERM key="ocp-v2.component.ParameterTemplate.Cluster">集群</UI-TERM>**，在 **<UI-TERM key="ocp-v2.page.Cluster.ClusterList">集群列表</UI-TERM>** 中进入备集群。
