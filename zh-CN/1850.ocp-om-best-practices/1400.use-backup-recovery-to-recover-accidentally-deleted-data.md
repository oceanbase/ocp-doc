...
* 通过 **<UI-TERM key="ocp-v2.src.util.menu.BackupAndRestoration">备份恢复</UI-TERM>** 路径发起恢复时，请确保当前登录 OCP 的用户具备如下权限：

  * **集群维护** 或 **租户维护** 资源权限。
  * 备份恢复 **<UI-TERM key="ocp-v2.Backup.Restore.Recovery">恢复</UI-TERM>** 菜单权限。

* 通过 **<UI-TERM key="ocp-v2.Detail.Monitor.Cluster">集群</UI-TERM>** > **<UI-TERM key="ocp-v2.src.util.menu.BackupAndRestoration">备份恢复</UI-TERM>** 路径发起恢复时，请确保当前登录 OCP 的用户具备如下权限：

  * **集群维护** 资源权限。
  * 集群 **<UI-TERM key="ocp-v2.Backup.BackupStrategy.New.BackupAndRestoration">备份恢复</UI-TERM>** 菜单权限。

* 通过 **<UI-TERM key="ocp-v2.Backup.Overview.Statistics.Tenant">租户</UI-TERM>** > **<UI-TERM key="ocp-v2.src.constant.package.BackupAndRestoration">备份恢复</UI-TERM>** 路径发起恢复时，请确保当前登录 OCP 的用户具备如下权限：
