...
1. 在左侧导航栏中，单击 **<UI-TERM key="ocp-v2.src.hook.useMenu.AlarmCenter">告警中心</UI-TERM>**。

2. 在告警中心页面，单击 **<UI-TERM key="ocp-v2.page.Alarm.AlarmChannel">告警通道</UI-TERM>**。

3. 然后在告警通道页签下，单击 **<UI-TERM key="ocp-v2.Alarm.Channel.New.CreateAChannel">新建通道</UI-TERM>**。
...
6. 单击 **<UI-TERM key="ocp-v2.Inspection.Item.ConfigRule.Submit">提交</UI-TERM>**，完成配置。
...
A：首先通过 curl 测试是否能发送测试消息，如果网络不通，则需要在 **<UI-TERM key="ocp-v2.Alarm.Channel.New.CreateAChannel">新建通道</UI-TERM>** > **<UI-TERM key="ocp-v2.Alarm.Rule.Detail.BasicConfiguration">基本配置</UI-TERM>** > **<UI-TERM key="ocp-v2.Channel.FormComponent.FeishuForm.Proxy">代理</UI-TERM>** 中配置网络代理。
