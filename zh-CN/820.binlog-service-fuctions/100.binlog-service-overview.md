...
Binlog 的转换服务的性能受资源配置和 Clog 解析能力的限制。不同的 Binlog 版本，所支持的 Clog 日志解析最大性能和每秒转换率（RPS）上限会有所不同，详情可参考 [Binlog 服务介绍](https://www.oceanbase.com/docs/common-oblogproxy-doc-1000000002039615) 中的 **限制说明**。如果源业务流量超过这些限制，可能会导致 Binlog 转换服务的延迟增加。
