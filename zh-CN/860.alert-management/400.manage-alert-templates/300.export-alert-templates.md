...
* 告警中心 **<UI-TERM key="ocp-v2.Auth.Role.All">全部</UI-TERM>** 菜单权限。
...
5. 单击 **<UI-TERM key="ocp-v2.Alarm.Template.ExportAlertTemplates">导出告警模板</UI-TERM>** 按钮，将查询结果以 .xlsx 格式导出至本地。
