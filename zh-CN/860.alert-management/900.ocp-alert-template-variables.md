...
| **<UI-TERM key="ocp-v2.Detail.Parameter.List.Category">类别</UI-TERM>** |          **<UI-TERM key="ocp-v2.SQLDiagnosis.Component.Plan.Name">名称</UI-TERM>**           |             **<UI-TERM key="ocp-v2.page.Property.Description">描述</UI-TERM>**             |
|--------|---------------------------|--------------------------------|
| 告警规则   | app_type                  | 应用类型                           |
