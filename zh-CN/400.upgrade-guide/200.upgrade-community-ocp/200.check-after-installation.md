...
* 验证基本功能，[添加主机](../../500.quickstart/400.quickstart-add-a-host.md)、[创建集群](../../500.quickstart/500.quickstart-create-a-cluster.md)、[创建租户](../../500.quickstart/600.quickstart-create-a-tenant.md) 以及 [查看监控](../../900.monitoring-and-alerts-functions/100.performance-monitoring-overview/100.ocp-monitoring-overview.md) 等功能。
