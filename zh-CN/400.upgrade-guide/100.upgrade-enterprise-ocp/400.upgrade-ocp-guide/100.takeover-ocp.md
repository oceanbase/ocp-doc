...
4. 在 **接管 OCP** 页面，配置各项参数。
   ...
   1. OCP 基础配置参数如下：
      ...
      | **<UI-TERM key="ocp-performance-report.ReportTables.ParameterStatInfo.ServerParamInfoTable.Parameter">参数</UI-TERM>** | **<UI-TERM key="ocp-v2.TakeOver.Component.ParameterDiffDrawer.Description">说明</UI-TERM>**    |
      |--------|-----------|
   ...
   2. OCP 元数据库 MetaDB 配置参数如下：
      ...
      | **<UI-TERM key="ocp-performance-report.ReportTables.ParameterStatInfo.TenantParamInfoTable.Parameter">参数</UI-TERM>**        | **<UI-TERM key="ocp-v2.Alarm.Rule.Description">说明</UI-TERM>**       |
      |---------------|-----------|
   ...
   3. （可选）负载均衡配置参数如下：
      ...
      | **<UI-TERM key="ocp-performance-report.ReportTables.ParameterStatInfo.TenantParamInfoTable.Parameter">参数</UI-TERM>**           | **<UI-TERM key="ocp-v2.Auth.Role.Description">说明</UI-TERM>**    |
      |----------|------------|
...
5. 接管 OCP 配置完成后，单击 **<UI-TERM key="ocp-v2.Inspection.Item.ConfigRule.Submit">提交</UI-TERM>** 。若您的配置有误，可单击 **<UI-TERM key="ocp-v2.SQLDiagnosis.Component.FieldListDrawer.Reset">重置</UI-TERM>** 一键恢复默认配置。
