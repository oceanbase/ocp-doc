...
3. 在左侧导航栏中单击 **OBProxy** ，检查监控：
   ...
   1. 检查 **<UI-TERM key="ocp-v2.component.OBProxyMonitorTop5.TopMetrics">监控指标 Top5</UI-TERM>** 中，图表是否显示正常。

   2. 在集群列表中单击 OBProxy 集群名称，进入 OBProxy 集群 **<UI-TERM key="ocp-v2.src.util.menu.SummaryInvestingComZa">概览</UI-TERM>** 界面。
