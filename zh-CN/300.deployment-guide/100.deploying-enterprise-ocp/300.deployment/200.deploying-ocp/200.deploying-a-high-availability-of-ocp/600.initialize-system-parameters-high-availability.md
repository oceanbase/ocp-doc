...
2. 在左侧导航栏上，单击 **<UI-TERM key="ocp-v2.src.util.menu.SystemManagement">系统管理</UI-TERM>** \> **<UI-TERM key="ocp-v2.page.Property.SystemParameters">系统参数</UI-TERM>** 。
...
3. 在参数列表中，找到需要修改的系统参数，修改初始化配置。
   ...
   |                 **<UI-TERM key="ocp-v2.page.Property.ParameterName">参数名</UI-TERM>**                  |                                                         **<UI-TERM key="ocp-v2.component.OperationConfig.List.Description">说明</UI-TERM>**                                                         |        **初始值**        |
   |------------------------------------------|------------------------------------------------------------------------------------------------------------------------|-----------------------|
   ...
   |      **<UI-TERM key="ocp-v2.component.ParameterTemplate.DetailDrawer.Parameter">参数名</UI-TERM>**       |     **<UI-TERM key="ocp-v2.page.Settings.Profile.Description">说明</UI-TERM>**     |
   |--------------------|----------------|
