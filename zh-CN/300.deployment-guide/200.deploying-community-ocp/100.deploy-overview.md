...
OceanBase 云平台（OceanBase Cloud Platform，OCP）伴随 OceanBase 数据库而生，是一款以OceanBase 为核心的企业级数据库管理平台。最新版本的 OCP 不仅能全面支持 OceanBase V2.2.76 \~ V4.x 等主流版本，还覆盖了常见的主机管理、OceanBase 集群和租户运维、备份恢复等功能，提供了精细的监控告警能力。
