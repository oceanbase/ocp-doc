...
| **管理的机器数量（台）** | **<UI-TERM key="ocp-v2.src.component.AddUnitSpecModal.CpuCore">CPU（核）</UI-TERM>** | **<UI-TERM key="ocp-v2.src.component.AddUnitSpecModal.MemoryGb">内存（GiB）</UI-TERM>** |
|----------------|------------|------------|
| ≤ 10           | 4          | 8          |
| ≤ 50           | 8          | 16         |
| ≤ 100          | 16         | 32         |
...
| **管理机器数量（台）** | **CPU（核心数）** | **<UI-TERM key="ocp-v2.Tenant.UnitSpec.MemoryGb">内存（GiB）</UI-TERM>** |
|---------------|--------------|-------------|
| ≤10           | 4            | 16          |
| ≤50           | 16           | 64          |
| ≤100          | 32           | 128         |
...
| **管理的机器数量（台）** | **<UI-TERM key="ocp-v2.src.component.AddUnitSpecModal.CpuCore">CPU（核）</UI-TERM>** | **<UI-TERM key="ocp-v2.Tenant.UnitSpec.MemoryGb">内存（GiB）</UI-TERM>** |
|----------------|------------|------------|
| ≤ 10           | 4          | 8          |
| ≤ 50           | 8          | 16         |
| ≤ 100          | 16         | 32         |
