...
您可通过 **<UI-TERM key="ocp-v2.alarm.FormListWithExclude.OBServerWithExclude.All">全部</UI-TERM>** 或 **<UI-TERM key="ocp-v2.Detail.Analyze.Failed">失败</UI-TERM>** 的统计维度查看 **<UI-TERM key="ocp-v2.src.constant.log.NearFenZhong.2">近 30 分钟</UI-TERM>**、**<UI-TERM key="ocp-v2.src.constant.log.NearlyHour">近 1 小时</UI-TERM>** 和 **<UI-TERM key="ocp-v2.component.RangeTimeDropdown.CustomTime">自定义时间</UI-TERM>** 以内的请求数据。
...
* **OBProxy 维护** 资源权限。
* OBProxy **<UI-TERM key="ocp-v2.src.hook.useMenu.RequestAnalysis">请求分析</UI-TERM>** 菜单权限。
...
在请求次数趋势模块，您可查看 **<UI-TERM key="ocp-v2.Detail.Analyze.ObproxyRequests">OBProxy 请求次数</UI-TERM>** 列表。
