|slug|obproxy-parameters-description|
|---|---|

# OBProxy 参数说明

本页面为您介绍刷新 OBProxy 的参数说明。创建 OBProxy 集群时，可在 **<UI-TERM key="ocp-v2.Component.AddZoneDrawer.ParameterSettings">参数设置</UI-TERM>** 中配置启动参数。
