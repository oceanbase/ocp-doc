...
2. 在任意目录下执行 `rpm -ivh` 或 `yum -y install` 命令启动升级程序。

3. 执行 `ocp-installer upgrade` ，并在返回信息中获取升级向导页面的 IP 地址。

![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/ocp/403-cn/%E5%8D%87%E7%BA%A7%E8%8E%B7%E5%8F%96ip.png)
