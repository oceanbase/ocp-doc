...
* 若您在部署 OCP 时选择使用已有集群，您需先自行创建好 meta 租户和 monitor 租户，详细创建方式可参考 [创建租户](https://www.oceanbase.com/docs/enterprise-oceanbase-database-cn-10000000000881617)；同时，需要对 meta 租户和 monitor 租户赋予 DDL 和 DML 权限。
