...
| **<UI-TERM key="ocp-v2.Alarm.Template.Detail.Indicators">指标</UI-TERM>** | **<UI-TERM key="ocp-v2.page.Property.Description">描述</UI-TERM>** |
| --- | --- |
...
| **<UI-TERM key="ocp-v2.component.alarm.RuleDetail.Metric">指标</UI-TERM>** | **<UI-TERM key="ocp-v2.page.Property.Description">描述</UI-TERM>** |
| --- | --- |
...
| **<UI-TERM key="ocp-v2.Alarm.Template.Detail.Indicators">指标</UI-TERM>** | **<UI-TERM key="ocp-v2.Cluster.Component.LoadTypeModal.Description">描述</UI-TERM>** |
| --- | --- |
| SQL 文本 | SQL 文本 |
| SQL ID | SQL 模版 |
...
| **<UI-TERM key="ocp-v2.Alarm.Rule.New.Indicators">指标</UI-TERM>** | **<UI-TERM key="ocp-v2.Cluster.Component.LoadTypeModal.Description">描述</UI-TERM>** |
| --- | --- |
