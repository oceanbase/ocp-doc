...
4. 配置 OBProxy 集群的 **基本信息** 。
   ...
   | 负载均衡管理  | 开启负载均衡管理后，可通过配置 OBLB 来提升 OBProxy 集群的负载均衡能力。<ul><li>OBLB 服务：您可选择部署 OCP 时已配置的 OBLB 服务，或单击 **添加 OBLB 服务** 按钮，在右侧面板中新建 OBLB 服务，详情可参考 [管理负载均衡](../800.obproxy-functions/300.manage-a-obproxy-cluster/300.manage-load-balancing.md) 中的 **新建负载均衡**。<ul><li>OBLB 服务地址：OBLB 的服务地址。</li><li>OBLB 服务端口：默认为 9090，可根据实际情况进行更改。</li><li>用户名及密码：OBLB 服务的用户名及密码，用于调用 OBLB 接口的认证信息。</li></ul></li><li>VIP：选择 OBLB 具体的 VIP 地址。</li><li>访问端口：默认为 2883，支持自定义端口号。</li><li>域名配置（可选）：用于指向 VIP 及端口的配置信息，平台未提供 VIP 与域名的映射关系，需自行准备域名解析服务。</li></ul><blockquote>**说明**</br>**负载均衡管理** 中的 **阿里云 SLB 服务** 仅适用于专有云环境，建议联系技术支持同学进行协助。</blockquote> |
