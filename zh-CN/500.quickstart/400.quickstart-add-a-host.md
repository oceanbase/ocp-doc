...
2. 在左侧导航栏中单击 **<UI-TERM key="ocp-v2.alarm.FormListWithExclude.HostWithExclude.Host">主机</UI-TERM>** **。**

3. 在页面右上角单击 **<UI-TERM key="ocp-v2.page.Host.AddHost">添加主机</UI-TERM>** 。

   ![05191443](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4819141261/p275300.png)

4. 填写 **<UI-TERM key="ocp-v2.Cluster.New.IpAddress">IP 地址</UI-TERM>** 和 **SSH 端口号** 。输入新主机的 IPv4 地址，支持同时添加多个 IP 地址（多个 IP 之间用英文逗号分隔）；SSH 端口号默认 22。
...
7. 在 **<UI-TERM key="ocp-v2.Cluster.Import.SelectCredentials">选择凭据</UI-TERM>** 列表中选择主机的登录凭据。
...
9. 单击 **<UI-TERM key="ocp-v2.Component.ClusterFilter.Ok">确定</UI-TERM>** 。
