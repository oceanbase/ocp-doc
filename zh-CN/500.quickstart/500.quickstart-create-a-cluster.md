...
6. 打开 **自定义配置**，对操作系统所属主用户、路径及端口进行配置 。
   ...
   * 配置操作系统所属主用户：
      ...
      <main id="notice" type='explain'>
      <h4>说明</h4>当您对 <code>ocp.operation.default.os.user</code> 参数进行修改后，该参数的修改仅对创建分布式集群、<a href="../800.obproxy-functions/200.create-an-obproxy-cluster.md">创建 OBProxy 集群</a> 和 <a href="../600.cluster-functions/400.manage-arbitration-services/200.creat-arbitration-services.md">创建仲裁服务</a> 时产生影响，不影响已有集群的其他配置。
      </main>
