...
3. 在 **<UI-TERM key="ocp-v2.src.constant.auditEvent.User">用户</UI-TERM>** 页签的右上角单击 **<UI-TERM key="ocp-v2.Auth.User.New.CreateAUser">创建用户</UI-TERM>** 。
...
5. 设置新用户的角色信息。
   ...
   * 若已有角色不合适，可单击区域右上角 **<UI-TERM key="ocp-v2.User.Oracle.CreateARole">新建角色</UI-TERM>** 并参考 [新建角色](../1600.system-management-features/200.manage-users/200.manage-a-role/100.create-a-role.md) 配置，创建一个新的角色，并将其分配给新用户。
...
7. 单击页面右下角 **<UI-TERM key="ocp-v2.Detail.Component.AddDatabaseModal.Submitted">提交</UI-TERM>** 。
