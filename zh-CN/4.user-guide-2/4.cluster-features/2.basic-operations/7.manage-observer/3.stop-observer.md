...
* （可选）如您不想停止 OBServer 的时候影响业务，则待停止的 OBServer 所在 Zone 内需还有其他 OBServer，且资源充足。这种情况下停止 OBServer，其上的 Unit 会自动切换到其他 OBServer，从而不影响业务。
