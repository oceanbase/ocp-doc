...
| [查看集群备份恢复详情](10.cluster-backup-and-recovery/1.cluster-backup-and-recovery.md)               | 您可在集群备份恢复页面中查看当前集群备份恢复的基础信息、详情和备份策略。                                         |
| [新建集群备份恢复策略](10.cluster-backup-and-recovery/2.create-a-backup-strategy.md)               | 您可参考本章节对需要备份的集群新建备份策略。                                         |
| [立即备份](10.cluster-backup-and-recovery/3.back-up.md)               | 您可参考本章节对集群进行立即备份。                               |
