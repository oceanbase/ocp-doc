...
| [停止 OBServer 服务](2.basic-operations/7.manage-observer/3.stop-observer.md)          | 您可通过停止 OBServer 的操作停止集群的 OBServer 服务。                                           |
| [停止 OBServer 进程](2.basic-operations/7.manage-observer/4.stop-observer-process.md)          | 您可通过停止 OBServer 的操作停止集群的 OBServer 进程。                                           |
| [替换 OBServer](2.basic-operations/7.manage-observer/5.replace-observer.md)          | 您可通过替换 OBServer 的操作替换集群的 OBServer。                                           |
| [重装 OBServer](2.basic-operations/7.manage-observer/6.1.reinstall-observer.md)          | 您可通过重装 OBServer 的操作重装集群的 OBServer。                                           |
