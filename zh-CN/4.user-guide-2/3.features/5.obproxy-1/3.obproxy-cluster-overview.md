...
同时，支持进行 OBPrxoy 常见运维操作，详情参见 [添加 OBProxy](../../8.obproxy/6.add-obproxy.md)、[添加可连接的 OB 集群](../../8.obproxy/10.add-a-connectable-ob-cluster.md)、[升级 OBProxy](../../8.obproxy/5.upgrade-obproxy.md)、[重启 OBProxy](../../8.obproxy/4.restart-obproxy-cluster.md)、[下载日志](../../10.system-management-features/13.log-service-overview.md)、[修改 Proxyro 账号的密码](../../8.obproxy/15.modify-proxyro-password.md)、[删除集群](../../4.cluster-features/2.basic-operations/3.delete-a-cluster-1.md)。
