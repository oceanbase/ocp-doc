...
* Method 1: On the tab of a dashboard, click **Add Chart** in the upper-right corner.
...
3. Go to the tab of the dashboard for which charts are to be added. Click **Add Chart** in the upper-right corner.
