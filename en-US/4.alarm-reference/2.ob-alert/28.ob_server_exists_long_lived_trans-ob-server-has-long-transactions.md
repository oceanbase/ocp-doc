...
* Overview example: ob_cluster=first:svr_ip=192.168.1.1. The OBServer has long transactions.

  

* Details example: ob_cluster=first:svr_ip=192.168.1.1. The OBServer has long transactions. The longest transaction lasts 1500.0s, exceeding the threshold of 1200.0s.
