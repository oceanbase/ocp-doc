...
* Overview example: ob_cluster=C1-1000:svr_ip=192.168.1.1. The inbound bandwidth usage of the OBServer exceeds the threshold.

  

* Details example: ob_cluster=C1-1000:svr_ip=192.168.1.1. The inbound bandwidth usage of the OBServer is 81.0%, exceeding the threshold of 80.0%.
