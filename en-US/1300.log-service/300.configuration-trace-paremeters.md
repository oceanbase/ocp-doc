|slug|configuration-trace-paremeters|
|---|---|
...
* **<UI-TERM key="ocp-v2.Auth.Role.Detail.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Auth.Role.AddRole.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.src.hook.useMenu.LogService">Log Service</UI-TERM>**
...
4. In the dialog box that appears, click **Modify system parameters** to go to the **<UI-TERM key="ocp-v2.page.Property.SystemParameters">System Parameters</UI-TERM>** page.
