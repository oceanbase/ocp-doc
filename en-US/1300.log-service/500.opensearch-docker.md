...
3. Connect OCP to OpenSearch.
   ...
   After you start OCP, you need to add the endpoints and credentials of OpenSearch on the **<UI-TERM key="ocp-v2.src.util.menu.SystemParameters">System Parameters</UI-TERM>** page. For more information, see [Configure trace query parameters](../1300.log-service/300.configuration-trace-paremeters.md).
