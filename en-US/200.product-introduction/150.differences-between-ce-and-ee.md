...
| OceanBase cluster management | Cluster security configuration (TDE, SSL) | Supported | Supported |
...
| Host management | Host, model, IDC, and region management | Supported | Supported |
...
| Monitoring | OceanBase Database tenant - OBKV-Redis | Supported | Supported |
...
| System management | External integration - AI model | Supported | Not supported |
| System management | External integration - SSO | Supported | Supported |
| O&M management | Information collection | Supported | Not supported |
| O&M management | Plan management | Supported | Not supported |
| O&M management | Inspection | Supported | Supported |
| O&M management | Report center | Supported | Supported |
| AI assistant | AI assistant | Supported | Not supported |
