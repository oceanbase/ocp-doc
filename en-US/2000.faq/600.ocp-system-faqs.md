...
A: Yes. You can select the target session and click **<UI-TERM key="ocp-v2.Detail.Session.List.CloseSession">Close Session</UI-TERM>** that appears in the lower right corner.
