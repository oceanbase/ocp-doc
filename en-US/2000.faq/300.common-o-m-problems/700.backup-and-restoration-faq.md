|slug|backup-and-restoration-faq|
|---|---|
...
A: Check the **<UI-TERM key="ocp-v2.Detail.Backup.State">Status</UI-TERM>** column to find out whether a task is completed.
...
A: Generally, it may take some time for the restore_concurrency parameter of OceanBase Database to take effect, and OCP will usually return an error. You may ignore the error after you commit **<UI-TERM key="ocp-v2.Detail.Backup.InitiateRecovery">Initiate Recovery</UI-TERM>** without any error.
