...
|------------|-----------------------|--------------|
| ssstore_read       | io_read_rt            | Microseconds |
...
| **Metric** | **Metric field name** |   **Unit**   |
|------------|-----------------------|--------------|
| ssstore_write      | io_write_rt           | Microseconds |
...
| **Metric** | **Metric field name** |   **Unit**   |
|------------|-----------------------|--------------|
| clog_read      | clog_io_read_rt         | Microseconds |
...
| **Metric** | **Metric field name** |   **Unit**   |
|------------|-----------------------|--------------|
| clog_write      | clog_io_write_rt       | Microseconds |
