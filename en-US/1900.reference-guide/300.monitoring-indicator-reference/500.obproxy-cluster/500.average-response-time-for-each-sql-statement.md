|slug|average-response-time-for-each-sql-statement|
|---|---|
...
|----------------------|----------------------------------------|--------------|
| prepare_send_request | request_cost_prepare_send_request_time | μs |
...
|       **<UI-TERM key="ocp-v2.Monitor.AddMonitor.VisualizationsTable.IndicatorItem">Metric</UI-TERM>**       |          **Metric field name**           |   **<UI-TERM key="ocp-v2.src.template.Table.Unit">Unit</UI-TERM>**   |
|------------------------|------------------------------------------|--------------|
| server_process_request | request_cost_server_process_request_time | μs |
...
| **<UI-TERM key="ocp-v2.Monitor.AddMonitor.VisualizationsTable.IndicatorItem">Metric</UI-TERM>** | **Metric field name** |   **<UI-TERM key="ocp-v2.src.template.Table.Unit">Unit</UI-TERM>**   |
|------------|-----------------------|--------------|
| sequence   | request_cost_sequence | μs |
