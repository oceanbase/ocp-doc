...
1. Check whether the error can be ignored.
   ...
   * If the error can be ignored, choose **<UI-TERM key="ocp-v2.Layout.BasicLayout.Alert">Alerts</UI-TERM>** \> **OceanBase Log Filtering** in the OCP console, and then set a rule to filter the error.
