...
* **Overview**
  ...
  * Example: obproxy_cluster_id=3:obproxy_cluster=obproxy_02-1:svr_ip=xxx.xxx.xxx.xxx OBProxy process does not exist
...
* **<UI-TERM key="ocp-v2.Alarm.Event.Detail.AlarmDetails">Alert Details</UI-TERM>**
  ...
  * Example: OBProxy cluster: obproxy_02, host: xxx.xxx.xxx.xxx, alert: OBProxy process does not exist.
