...
* **Alert overview**
  ...
  * Example: alarm_template_id=0:ob_cluster=TEST-1:tenant_name=t1. Partitions in the OceanBase tenant lack a primary replica.

* **Alert details**

  * Template: Cluster: ${ob_cluster_name}. Tenant: ${tenant_name}. Alert: ${alarm_name}.
  * Example: Cluster: TEST. Tenant: t1. Alert: Partitions in the OceanBase tenant lack a primary replica.

* **Alert recovery**

  * Template: Alert: ${alarm_name}. Number of tenants without primary partitions: \${recover_value}
  * Example: Alert: OceanBase tenant partitions lack a primary replica. Number of tenants without primary partitions: 85.
