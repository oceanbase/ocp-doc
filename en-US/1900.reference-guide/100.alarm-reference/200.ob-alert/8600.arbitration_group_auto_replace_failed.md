...
* **Alert details**
  ...
  * Template: An automatic arbitration service switching task of the \${group_name} arbitration service group failed.
  * Example: An automatic arbitration service switching task of the arbitration_group_A arbitration service group failed.

* **Alert recovery**

  * Template: Alert: ${alarm_name}, Automatic arbitration service switching task status: \${recover_value}
  * Example: Alert: Automatic arbitration service switching task failed, Automatic arbitration service switching task status: 1
