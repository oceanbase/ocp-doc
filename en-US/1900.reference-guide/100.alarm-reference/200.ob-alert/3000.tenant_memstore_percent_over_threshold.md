|slug|tenant_memstore_percent_over_threshold|
|---|---|
...
2. Throttle the concurrency of SQL statements or increase the memory size in the unit specification of the tenant based on the check result.
   ...
   1. Go to the **<UI-TERM key="ocp-v2.Detail.Realtime.PerformanceMonitoring">Performance Monitoring</UI-TERM>** page of this tenant in the OceanBase Cloud Platform (OCP) console, and then click the **Performance & SQL** tab.

   2. Select **<UI-TERM key="ocp-v2.component.TenantMonitorTop5.LastWeek">Last 7 Days</UI-TERM>** for **<UI-TERM key="ocp-v2.component.MonitorSearch.SelectTime">Select Time</UI-TERM>**.
