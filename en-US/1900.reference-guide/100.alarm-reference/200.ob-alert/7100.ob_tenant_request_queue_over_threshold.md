...
* **Alert Details**
  ...
  * Template: Cluster: \${ob_cluster_name}. Tenant: \${tenant_name}. Alert: \${alarm_name}. The length of the request queue of the tenant reaches \${ob_tenant_request_queue_size_value}, which exceeds the threshold \${ob_tenant_request_queue_size_alarm_threshold}. The tenant SQL request waits in the queue for \${request_queue_time_value_zh_cn} microseconds.
  * Example: Cluster: TEST. Tenant: test. Alert: The length of the request queue of the OceanBase Database tenant exceeds the threshold. The length of the request queue of the tenant reaches 100, which exceeds the threshold 10. The tenant SQL request waits in the queue for 1300 microseconds.

* **Alert Recovery**

  * Template: Alert: \${alarm_name}. The OceanBase tenant SQL request waits in the queue for \${request_queue_time_value_zh_cn} microseconds. The length of the OceanBase tenant request queue is \${ob_tenant_request_queue_size_value}.
  * Example: Alert: The length of the OceanBase tenant request queue exceeds the threshold. The OceanBase tenant SQL request waits in the queue for 0 microseconds. The length of the OceanBase tenant request queue is 5.
