...
* **Alert overview**
  ...
  * Example: alarm_template_id=0:host=xxx.xxx.xxx.xxx:name=ocp_mgragent. The number of ocp-agent processes is abnormal.
...
* **Alert recovery**
  ...
  * Template: Alert: ${alarm_name}. Number of processes: \${value}
  * Example: The number of ocp-agent processes is abnormal. Number of processes: 0
