|slug|ob_cluster_frozen_version_delta_over_threshold|
|---|---|

ob_cluster_frozen_version_delta_over_threshold
===================================================================

**<UI-TERM key="ocp-v2.src.template.Table.Description">Description</UI-TERM>**
------------------------------------
