...
* **Overview**
  ...
  * Example: obproxy_template_id=0:obproxy_cluster=obproxy_01:host=xxx.xxx.xxx.xxx. OBProxy cannot be connected.

* **Details**

  * Template: OBProxy cluster: \${obproxy_cluster}. Host: \${host}. Alert: \${alarm_name}. Cause: ${failed_reason}. 
  * Example: OBProxy cluster: obproxy_02. Host: xxx.xxx.xxx.xxx. Alert: OBProxy cannot be connected. Cause: OBPROXY_CONNECTION_ERROR.
