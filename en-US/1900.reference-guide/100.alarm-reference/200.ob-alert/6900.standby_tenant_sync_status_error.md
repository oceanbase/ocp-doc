...
* **Alert Recovery**
  * Template: Alert: ${alarm_name}, Is the synchronization status of the standby tenant normal: \${recover_value}
  * Sample: Alert: The synchronization status of the standby tenant is abnormal, Is the synchronization status of the standby tenant normal: Yes
