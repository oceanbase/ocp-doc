...
* **Alert overview**
  ...
  * Example: ob_cluster=obcluster-1:tenant_name=sys:sql_id=2A6D6C59E6D86C57519267B5EC2CBEC3 A slow SQL statement exists in the OceanBase tenant.
