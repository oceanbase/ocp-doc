...
* **Alert overview**
  ...
  * Example: ob_cluster=C1-1000:svr_ip=xxx.xxx.xxx.xxx OBServer task timeout
* **Alert details**
  * Template: Cluster: ${ob_cluster_name}. Host: ${host} (zone: ${obzone}). Alert: A task in the OBServer has timed out. Task Type: ${task_type}. Execution Time: ${value_shown}, which exceeds the threshold of ${alarm_threshold} seconds.
  * Example: Cluster: C1. Host: xxx.xxx.xxx.xxx (zone: Z1). Alert: A task in the OBServer has timed out. Task Type: DELETE_SERVER. Execution Time: 4 hours, which exceeds the threshold of 10800 seconds.
* **Alert recovery**
  * Template: Alert: ${alarm_name}. OBServer task execution time: ${value_shown}
  * Example: Alert: OBServer task timeout. OBServer task execution time: 2 hours
