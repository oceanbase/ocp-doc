...
|     Parameter     | Value       |
|-------------------|-----------------|
| Metric            | active_session<blockquote>**<UI-TERM key="ocp-v2.page.Credential.Binlog.Description">Note</UI-TERM>**<br>The number of active sessions. This alert is triggered when the value of this metric exceeds the threshold, which is 10000 by default.  </blockquote>     |
...
* **Overview**
  ...
  * Example: ob_cluster=obcluster-1:svr_ip=xxx.xxx.xxx.xxx Excessive number of active OBServer sessions

* **Details**
  * Template: Cluster: ${alarm_target}, Host: ${host}, Alert: ${alarm_name}. OceanBase Server ${host} active sessions: ${value}, exceeding ${alarm_threshold}.
  * Example: Cluster: obcluster-1, Host: xxx.xxx.xxx.xxx, Alert: Excessive number of active OBServer sessions. OceanBase Server xxx.xxx.xxx.xxx active sessions: 1000, exceeding 500.

* **Alert recovery**
  * Template: Alert: ${alarm_name}, OBServer active sessions: ${value}
  * Example: Alert: Excessive number of active OBServer sessions. OBServer active sessions: 300
...
2. Check whether spikes occur in peak hours.
   ...
   You can view the metric trend charts on the **Database Performance** tab of the **<UI-TERM key="ocp-v2.Instance.Monitor.PerformanceMonitoring">Performance Monitoring</UI-TERM>** page. For more information, see [Performance monitoring](../../../880.manage-performance-monitoring/100.performance-monitoring-overview/200.view-clusters-performance.md).
