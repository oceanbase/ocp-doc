...
* **Alert Recovery**
  * Template: Alert: ${alarm_name}, Synchronization latency of the standby tenant: \${value} seconds.
  * Sample: Alert: Synchronization latency of the standby tenant is high. Synchronization latency of the standby tenant: 68 seconds.
