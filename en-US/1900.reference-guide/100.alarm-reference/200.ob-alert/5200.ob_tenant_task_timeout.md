...
* **Alert overview**
  ...
  * Example: ob_cluster=C1-1000:tenant_name=T1. A task in the OceanBase tenant timed out.
* **Alert details**
  * Template: Cluster: ${ob_cluster_name}. Tenant: ${tenant_name}. Host: ${host} (zone: ${obzone}). Alert: A system task in the OceanBase tenant has timed out. Task Type: ${task_type}; Execution Time: ${value_shown}, which exceeds the threshold of ${alarm_threshold} seconds.
  * Example: Cluster: C1. Tenant: T1. Host: xxx.xxx.xxx.xxx (zone: Z1). Alert: A system task in the OceanBase tenant has timed out. Task Type: MIGRATE_UNIT. Execution Time: 4 hours, which exceeds the threshold of 10800 seconds.
* **Alert restored**
  * Template: Alert: ${alarm_name}. OceanBase tenant system task running time: ${value_shown}
  * Example: Alert: OceanBase tenant system task timeout. OceanBase tenant system task running time: 2 hours
