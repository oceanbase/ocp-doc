...
This alert is triggered when you perform an O&M task on a host that is managed by OceanBase Cloud Platform (OCP). This alert is at the **<UI-TERM key="ocp-v2.src.constant.alarm.Reminder">Reminder</UI-TERM>** level. You can change the alert level as needed.
