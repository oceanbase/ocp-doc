|slug|obproxy_cluster_operation|
|---|---|
...
After you perform an O&M task on an OBProxy cluster, this alert is triggered. This alert is at the **<UI-TERM key="ocp-v2.src.constant.alarm.Reminder">Reminder</UI-TERM>** level. You can customize the alert level.
