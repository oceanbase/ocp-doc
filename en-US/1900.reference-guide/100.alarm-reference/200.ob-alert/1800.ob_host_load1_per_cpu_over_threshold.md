...
* **Overview**
  ...
  * Example: ob_cluster=C1-1000:svr_ip=xxx.xxx.xxx.xxx. The CPU load average of the OBServer over the last minute exceeds the threshold.

* **Details**
  * Template: Cluster: \${ob_cluster_name}, Host: \${host}, Alert: \${alarm_name}. The last minute is \${value}, exceeding the threshold of \${alarm_threshold}.
  * Example: Cluster: obcluster-1, Host: xxx.xxx.xxx.xxx, Alert: The CPU load average of the OBServer over the last minute exceeds the threshold. The last minute is 3.0, exceeding the threshold of 2.0.
  
* **Restored**
  * Template: Alert: ${alarm_name}, Server load1/CPU cores: \${value}
  * Example: Alert: OceanBase server CPU load average exceeds the threshold, Server load1/CPU cores: 1.5
