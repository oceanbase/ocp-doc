...
3. Check whether Root Service is leaderless.
   ...
   * If the sys tenant is normally connected but the query fails, Root Service is leaderless.
     ...
     2. Find the target OBServer in the **<UI-TERM key="ocp-v2.Cluster.Component.MachineResource.NumberOfObservers">OBServers</UI-TERM>** list on the **<UI-TERM key="ocp-v2.page.Overview.Overview">Overview</UI-TERM>** page of the cluster, and then click **<UI-TERM key="ocp-v2.Detail.Component.RestartModal.Restart">Restart</UI-TERM>** .
