|slug|inc_backup_delay|
|---|---|

inc_backup_delay
=====================================

**<UI-TERM key="ocp-v2.Detail.Component.Event.Description">Description</UI-TERM>**
------------------------------------
...
* If the alert is triggered during a physical log backup task, check the OBServer logs to find the specific cause. Perform the following steps to find the logs:
  ...
  1. Log on to the OCP console. On the **<UI-TERM key="ocp-v2.Cluster.Component.ClusterList.ClusterList">Clusters</UI-TERM>** page, find the target cluster in the **<UI-TERM key="ocp-v2.page.Cluster.ClusterList">Clusters</UI-TERM>** list and click its name. Then, the **<UI-TERM key="ocp-v2.page.Overview.Overview">Overview</UI-TERM>** page of the cluster appears.

  2. Click the **<UI-TERM key="ocp-v2.page.Welcome.SeeMore">More</UI-TERM>** icon in the upper-right corner and select **<UI-TERM key="ocp-v2.page.QueryLog.DownloadAllLogs">Download Logs</UI-TERM>** .
  ...
  3. Click **<UI-TERM key="ocp-v2.Detail.Report.DownloadReport">Download</UI-TERM>** .
