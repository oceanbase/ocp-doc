...
* **Alert recovery**
  * Template: Alert: ${alarm_name}, number of times OBProxy instance expansion failure: \${recover_value}
  * Example: Alert: OBProxy instance expansion failure, number of times OBProxy instance expansion failure: 0
