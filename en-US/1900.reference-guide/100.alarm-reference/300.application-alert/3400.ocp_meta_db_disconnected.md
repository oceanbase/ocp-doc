...
* **Alert overview**
  ...
  * Sample: alarm_template_id=0:svr_ip=xxx.xxx.xxx.xxx:db=monitor OCP Meta DB disconnected.
* **Alert details**
  * Template: [${alarm_name}] OCP ${db} DB is disconnected.
  * Sample: [OCP Meta DB disconnected] OCP monitor DB is disconnected.
* **Alert recovery**
  * Template: Alert: ${alarm_name}, OCP Meta DB health status: \${recover_value}
  * Sample: Alert: OCP Meta DB disconnected, OCP Meta DB health status: 1
