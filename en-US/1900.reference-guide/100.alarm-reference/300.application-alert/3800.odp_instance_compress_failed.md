...
* **Alert Recovery**
  * Template: Alert: ${alarm_name}, OBProxy instance scale-down failure count: \${recover_value}
  * Example: Alert: OBProxy instance scale-down failure, OBProxy instance scale-down failure count: 0
