...
This alert is generated when the amount of data in the recycle bin exceeds 100 GiB.
...
* **Alert details**
  ...
  * Template: Cluster: ${ob_cluster_name}. Alert: ${alarm_name}. The disk space occupied by the data in the recycle bin is ${value_shown}, which exceeds ${alarm_threshold} GiB.
  * Sample: Cluster: Test. Alert: ob_cluster_recyclebin_disk_used_over_threshold. The disk space occupied by data in the recycle bin is 120 GiB, which exceeds 100 GiB.

* **Alert recovery**
  * Template: Alert: ${alarm_name}, OceanBase recycle bin disk usage: \${value_shown}
  * Sample: Alert: ob_cluster_recyclebin_disk_used_over_threshold, OceanBase recycle bin disk usage: 90 GiB
