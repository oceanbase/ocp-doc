...
2. Upload the certificate in OCP. For more information, see [Upload a certificate](../../../1600.system-management-features/150.manage-certificates/200.upload-certificates.md).
3. Update the certificates for the OceanBase cluster and OBProxy cluster that use the expired certificate. For more information, see [Manage SSL encryption for an OceanBase cluster](../../../600.cluster-functions/1200.manage-security-configuration/100.manage-ssl-link-encryption-of-an-ob-cluster.md) and [Manage SSL encryption for an OBProxy cluster](../../../800.obproxy-functions/550.manage-ssl-link-encryption-of-an-obproxy-cluster.md).