...
* Check whether the OBProxy process is normal.
  ...
  In OCP, select the OBProxy host and check whether relevant OBProxy processes are normal in the **<UI-TERM key="ocp-v2.Host.Detail.OCPAgent.Processes">Processes</UI-TERM>** list on the **OCP Agent** tab.
