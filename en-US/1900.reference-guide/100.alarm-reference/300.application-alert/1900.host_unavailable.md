...
3. Check whether the OCP-Agent-related processes are running.
   ...
   * If a process is abnormal, click **<UI-TERM key="ocp-v2.src.util.component.Restart">Restart</UI-TERM>** next to this process in the **<UI-TERM key="ocp-v2.Host.Detail.OCPAgent.Processes">Processes</UI-TERM>** list. You can also run the OCP-Agent O&M script to restart the OCP-Agent and restore the OCP-Agent service.
