...
* **Alert overview**
  ...
  * Example: alarm_template_id=0:ob_cluster=AdminMETA-12:host=xxx.xxx.xxx.xxx ocp_agentd process stopped

* **Alert details**

  * Template: Cluster: ${ob_cluster_name}. Host: ${host}. Alert: ${alarm_name}.
  * Example: Cluster: AdminMETA. Host: xxx.xxx.xxx.xxx. Alert: ocp_agentd process stopped.

* **Alert recovery**

  * Template: Alert: ${alarm_name}. OCP-Agent daemon startup timestamp change: \${recover_value}
  * Example: Alert: ocp_agentd process stopped. OCP-Agent daemon startup timestamp change: 0 seconds
