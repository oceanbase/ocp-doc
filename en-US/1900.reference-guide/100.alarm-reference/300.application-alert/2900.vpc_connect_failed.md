...
|     Parameter     |                                                                                             Value                                                                                              |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Metric            | vpc_network_health <blockquote>**<UI-TERM key="ocp-v2.src.component.AddBinlogCredentialModal.Description">Note</UI-TERM>**  <br>The result returned by the health check interface. When the value is 1, OCP cannot access other VPCs and this alert is triggered. </blockquote>                |
