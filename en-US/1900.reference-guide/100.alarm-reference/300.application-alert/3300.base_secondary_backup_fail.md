|slug|base_secondary_backup_fail|
|---|---|
...
1. Log on to the OCP console. On the **<UI-TERM key="ocp-v2.page.Cluster.ClusterList">Clusters</UI-TERM>** page, find the target cluster in the **<UI-TERM key="ocp-v2.page.Cluster.ClusterList">Clusters</UI-TERM>** list and click its name. Then, the **<UI-TERM key="ocp-v2.src.util.menu.SummaryInvestingComZa">Overview</UI-TERM>** page of the cluster appears.

2. Click the **<UI-TERM key="ocp-v2.Cluster.Component.MachineResource.SeeMore">More</UI-TERM>** icon in the upper-right corner and select **<UI-TERM key="ocp-v2.src.constant.task.DownloadLogs">Download Logs</UI-TERM>**.
...
3. Click **<UI-TERM key="ocp-v2.page.QueryLog.DownloadAllLogs">Download Logs</UI-TERM>** to download the OBServer logs.
