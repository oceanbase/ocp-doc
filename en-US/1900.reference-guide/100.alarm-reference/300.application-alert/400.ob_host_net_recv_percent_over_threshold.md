...
**<UI-TERM key="ocp-v2.component.alarm.RuleDetail.Description">Description</UI-TERM>**
------------------------------------
...
|     Parameter     |                                                                                                                                                                                                                                                                                 Value                                                                                                                                                                                                                                                                                  |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Metric            | ob_host_net_recv_percent  |
...
The value of the metric ob_host_net_recv_percent indicates the inbound bandwidth usage of the OBServer. When this value exceeds the threshold, this alert is triggered. The default threshold is 80%.
...
|--------------------------|-----------------------------|-------------|-----------------|-----------------------|
| ob_host_net_recv_percent | 80                          | 120 seconds | 60 seconds      | 5 minutes             |
...
* **Overview**
  ...
  * Example: ob_cluster=obcluster-1:svr_ip=xxx.xxx.xxx.xxx. The inbound bandwidth usage of the OBServer exceeds the threshold.

* **Details**
  * Template: Cluster: ${ob_cluster_name}, Host: ${host}, Alert: ${alarm_name}. The inbound bandwidth usage of the OBServer is ${value}%, exceeding the threshold of ${alarm_threshold} %.
  * Example: Cluster: obcluster-1, Host: xxx.xxx.xxx.xxx, Alert: The inbound bandwidth usage of the OBServer exceeds the threshold. The inbound bandwidth usage of the OBServer is 81.0%, exceeding the threshold of 80.0%.

* **Alert restored**
  * Template: Alert: ${alarm_name}. The inbound bandwidth usage of the OBServer is ${value}.
  * Example: Alert: The inbound bandwidth usage of the OBServer exceeds the threshold. The inbound bandwidth usage of the OBServer is 75%.
...
Go to the **<UI-TERM key="ocp-v2.src.hook.useMenu.Monitoring">Monitoring</UI-TERM>** page of the host that triggered the alert in the OCP console, and then view the network throughput on the **<UI-TERM key="ocp-v2.Monitor.AddMonitor.AddMonitorDrawer.HostPerformance">Host Performance</UI-TERM>** tab.
