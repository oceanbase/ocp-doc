...
When you do not want to receive some alerts, you can block them. For more information, see [Create a blocking condition](../../900.monitoring-and-alerts-functions/200.alert-management/800.manage-blocking-conditions/100.create-a-blocking-condition.md).
