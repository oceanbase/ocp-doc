...
* **Alert Restoration**
  ...
  * Template: Alert: ${alarm_name}, number of server network traffic errors: \${value_shown}
  * Example: Alert: os_tsar_traffic_error, number of server network traffic errors: 2
