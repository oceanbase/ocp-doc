...
* **Alert Details**
  ...
  * Example: Cluster: obcluster-1, host: xxx.xxx.xxx.xxx, alert: os_tsar_cpu_sys_abnormal. Percentage of system CPU time 51.01 % exceeds 40 %.

* **Alert Restoration**

  * Template: Alert: ${alarm_name}, server CPU system usage: \${value_shown}
  * Example: Alert: os_tsar_cpu_sys_abnormal, server CPU system usage: 30 %
