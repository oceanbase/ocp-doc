...
* **Alert overview**
  ...
  * Example: ob_cluster=obcluster-1631964370:svr_ip=xxx.xxx.xxx.xxx:device=dm-1 OceanBase server IO Hang

* **Alert details**

  * Template: Cluster: \${ob_cluster_name}, host: \${host}, alert: \${alarm_name}. OceanBase disk: \${ob_device}, device ${device}, io util \${io_util_value_zh_cn} exceeds \${io_util_alarm_threshold} %, io qusize \${io_qusize_value} exceeds \${io_qusize_alarm_threshold}.
  * Example: Cluster: obcluster-1, host: xxx.xxx.xxx.xxx, alert: OceanBase server IO Hang. OceanBase disk: ob_data, device dm-1, io util 99.1 % exceeds 99 %, io qusize 30 exceeds 20.

* **Alert recovery**

  * Template: Alert: ${alarm_name}, OceanBase disk io_util: \${io_util_value_zh_cn}, OceanBase disk io_qusize: \${io_qusize_value}, OceanBase disk average read/write time: \${recover_value}
  * Example: Alert: OceanBase server IO Hang, OceanBase disk io_util: 80 %, OceanBase disk io_qusize: 15, OceanBase disk average read/write time: 5 seconds
