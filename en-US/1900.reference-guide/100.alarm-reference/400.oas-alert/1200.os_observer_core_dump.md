...
* **Alert Overview**
  ...
  * Example: ob_cluster=obcluster-1631964370:svr_ip=xxx.xxx.xxx.xxx OceanBase server Core Dump
* **Alert Details**
  * Template: Cluster: \${ob_cluster_name}, host: \${host}, alert: an OceanBase server core dump file was generated \${value_shown} ago.
  * Example: Cluster: obcluster-1, host: xxx.xxx.xxx.xxx, alert: an OceanBase server core dump file was generated 10 minutes ago.
* **Alert Restoration**
  * Template: Alert: ${alarm_name}, time since the last core dump on the OBServer: \${value_shown}
  * Example: Alert: OceanBase server Core Dump, time since the last core dump on the OBServer: 0 seconds
