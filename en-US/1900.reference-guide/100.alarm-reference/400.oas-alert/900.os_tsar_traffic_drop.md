...
* **Alert Details**
  ...
  * Example: Cluster: obcluster-1, host: xxx.xxx.xxx.xxx, alert: os_tsar_traffic_drop. Average packet losses 5.2 exceeds 1.
* **Alert Restoration**
  * Template: Alert: ${alarm_name}, packet loss: \${value_shown}
  * Example: Alert: os_tsar_traffic_drop, packet loss: 0
