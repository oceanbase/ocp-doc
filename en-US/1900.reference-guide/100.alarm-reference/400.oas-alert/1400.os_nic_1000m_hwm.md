...
* **Alert Details**
  * Template: Cluster: \${ob_cluster_name}, host: \${host}, NIC: ${device}, alert: \${alarm_name}. NIC bandwidth usage \${eth_net_traffic_usage_value_zh_cn} exceeds \${eth_net_traffic_usage_alarm_threshold} %, NIC bandwidth is ${eth_net_bandwidth_mbps_value_zh_cn}.
  * Example: Cluster: obcluster-1, host: xxx.xxx.xxx.xxx, NIC: eno1, alert: os_nic_1000m_hwm. NIC bandwidth usage 91.15 % exceeds 80 %, NIC bandwidth is 300 Mbps.
* **Alert Restoration**
  * Template: Alert: ${alarm_name}, server NIC in/out packet traffic ratio: \${eth_net_traffic_usage_value_zh_cn}, server eth.* NIC bandwidth: \${eth_net_bandwidth_mbps_value_zh_cn}
  * Example: Alert: os_nic_1000m_hwm, server NIC in/out packet traffic ratio: 65 %, server eth.* NIC bandwidth: 100 Mbps
