...
* **Alert Recovery**
  * Template: Alert: ${alarm_name}, server CPU utilization: user + system + nice + irq + softirq + steal = \${value_shown}
  * Example: Alert: os_tsar_cpu_util_full, server CPU utilization: user + system + nice + irq + softirq + steal = 90 %
