...
* **Alert overview**
  ...
  * Example: ob_cluster=obcluster-1631964370:svr_ip=xxx.xxx.xxx.xxx:device=dm-0 OceanBase server NVMe disk ioawait high

* **Alert details**

  * Template: Cluster: \${ob_cluster_name}, host: \${svr_ip}, alert: \${alarm_name}. OceanBase disk: \${ob_device}, device \${device}, io await \${io_await_value_zh_cn} exceeds \${io_await_alarm_threshold} ms, io util \${io_util_value_zh_cn} exceeds ${io_util_alarm_threshold} %, io qusize \${io_qusize_value} exceeds \${io_qusize_alarm_threshold}.
  * Example: Cluster: obcluster-1, host: xxx.xxx.xxx.xxx, alert: OceanBase server NVMe disk ioawait high. OceanBase disk: ob_log, device dm-0, io await 30 ms exceeds 20 ms, io util 99 % exceeds 98 %, io qusize 33 exceeds 20.

* **Alert recovery**

  * Template: Alert: ${alarm_name}, OBServer disk io_util: \${io_util_value_zh_cn}, OBServer disk io_qusize: \${io_qusize_value}, OBServer disk io_await: \${io_await_value_zh_cn}
  * Example: Alert: OceanBase server NVMe disk ioawait high, OBServer disk io_util: 95 %, OBServer disk io_qusize: 15, OBServer disk io_await: 15 ms
