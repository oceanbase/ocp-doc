...
* **Alert Recovery**
  ...
  * Template: Alert: ${alarm_name}, server NIC traffic ratio: \${eth_net_traffic_usage_value_zh_cn}, server eth.* NIC bandwidth: \${eth_net_bandwidth_mbps_value_zh_cn}
  * Example: Alert: os_tsar_traffic_overload, server NIC traffic ratio: 65 %, server eth.* NIC bandwidth: 100 Mbit/s
