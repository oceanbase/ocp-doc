...
* **Alert Recovery**
  ...
  * Template: Alert: ${alarm_name}, server CPU utilization: user, system, nice, irq, softirq, and steal: \${cpu_used_percent_value_zh_cn}, server CPU steal utilization: \${cpu_steal_value_zh_cn}
  * Example: Alert: server CPU utilization exceeds threshold, server CPU utilization: user, system, nice, irq, softirq, and steal: 80 %, server CPU steal utilization: 30 %
