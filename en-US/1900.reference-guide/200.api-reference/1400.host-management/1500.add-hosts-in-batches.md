...
| kind              | String      | Yes      | DEDICATED_PHYSICAL_MACHINE | The host category. Valid values: <li> DEDICATED_PHYSICAL_MACHINE: indicates a physical machine. </li><li>DEDICATED_ECS: indicates a ECS. </li>    |
