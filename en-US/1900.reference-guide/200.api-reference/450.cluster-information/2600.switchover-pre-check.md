...
`POST /api/v2/ob/clusters/{id}/switchoverPreCheck`
...
|-------------|----------|-----------------------|
| data | Object | The result of the switchover pre-check. For more information, see the following table. |
...
| Parameter | Type | Description |
|-------|-------------|--------|
| clusterId | Long | The ID of the OceanBase cluster in OCP.  |
...
`POST /api/v2/ob/clusters/1/switchoverPreCheck`
