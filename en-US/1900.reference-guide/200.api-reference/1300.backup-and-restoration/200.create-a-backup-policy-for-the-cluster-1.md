...
| \|--s3AccessKey                            | Object | No  | S3 credentials. This parameter is valid only when `backupStorageType=BACKUP_STORAGE_S3`.
| \|--s3AccessKey                            | Object | No  | S3 information. This parameter is valid only when `backupStorageType=BACKUP_STORAGE_S3`.
| \|--endpoint                               | String | Yes | The domain name for accessing.
| \|--accessKeyId                            | String | Yes | The ID of the access key.        |
| \|--accessKeySecret                        | String | Yes | The access secret key.
