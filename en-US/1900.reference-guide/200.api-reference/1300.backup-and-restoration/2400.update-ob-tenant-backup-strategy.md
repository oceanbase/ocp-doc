...
| \|--nodeList        | Array   | Yes  | The backup node collection. Nodes in the same index have the same priority, and multiple nodes in the same index are separated with commas, for example: ["zone1,zone2", "zone3"].       |
