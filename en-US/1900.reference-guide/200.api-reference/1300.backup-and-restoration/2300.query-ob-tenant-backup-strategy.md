...
|  nodeList           |  Array  | Required. The collection of backup nodes. Nodes at the same index have the same priority. Separate multiple nodes at the same index with commas (,). Example: ["zone1,zone2", "zone3"].  |
