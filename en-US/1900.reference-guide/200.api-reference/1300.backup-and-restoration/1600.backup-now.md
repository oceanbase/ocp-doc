...
| \|--nodeList        | Array   | Yes  | The backup node collection. The priority of nodes at the same index is the same. Multiple nodes at the same index are separated by commas. Example: ["zone1,zone2", "zone3"].       |
