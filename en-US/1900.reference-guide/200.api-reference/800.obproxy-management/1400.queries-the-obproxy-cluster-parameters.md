|slug|queries-the-obproxy-cluster-parameters|
|---|---|
...
|------------|----------|-------------------------------------------------------------------------|
| data       | Array    | Details see **ObproxyClusterParameter data structure**.                                      |
...
| values      | Array  | Details see **ObproxyParameterValue data structure**.  |
