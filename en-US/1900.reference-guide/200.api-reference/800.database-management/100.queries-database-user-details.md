...
| globalPrivileges        | StringArray | The global privilege list:<li>For a MySQL tenant, this field indicates the global privileges.</li><li>For an Oracle tenant, this field indicates the system privileges.</li>    |
...
| ├─ connectionStringType | String      | The type of the connection string. The value range:<li>OBPROXY</li><li>DIRECT</li>                            |
...
|     Parameter     |   Type   |      Description      |
|------------|--------|------------|
| objectType | String | The type of the database object. The value range:<li>TABLE</li><li>VIEW</li><li>STORED_PROCEDURE</li>    |
