...
You can call this operation to change database privileges of a user.
...
|   Parameter   |    Type     | Required |  Example value   |                    Description                    |
|---------------|-------------|----------|------------------|---------------------------------------------------|
| dbPrivileges  | Array       | No       | N/A              | The list of database privileges to be changed to. |
...
Change the privileges of user1 on db1 in Tenant 1000001 of Cluster 1 to CREATE and SELECT. 
