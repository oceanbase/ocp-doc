|slug|queries-detailed-information-about-a-database-role|
|---|---|
...
| Parameter  |  Type  |   Description      |
|------------|--------|----------|
| objectType | String | The type of the database object. Valid values: <li>TABLE: table</li><li>VIEW: view</li><li>STORED_PROCEDURE: stored procedure</li>    |
