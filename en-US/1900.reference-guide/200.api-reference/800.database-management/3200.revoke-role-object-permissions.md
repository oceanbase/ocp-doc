|slug|revoke-role-object-permissions|
|---|---|
...
You can call this operation to revoke object privileges of a role
...
Revoke the SELECT and UPDATE privileges of ROLE1 on Table U1.T1 in Tenant 1000001 of Cluster 1. 
