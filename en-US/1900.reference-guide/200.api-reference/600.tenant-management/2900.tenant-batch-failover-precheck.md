|slug|tenant-batch-failover-precheck|
|---|---|
...
|---------|---------|---------|---------|----------|
| id        | integer | Yes  | 3000010       | ID of the cluster to which the standby tenant belongs, as obtained from OCP. |
...
| tenantId    | Long      | The ID of the standby tenant in OCP. |
| name                | String  | The name of the standby tenant. |
| clusterId           | Long    | The ID of the cluster to which the standby tenant belongs in OCP. |
...
`POST /api/v2/ob/clusters/3000010/tenants/failoverPreCheck`
