...
This topic describes the API for unlocking a tenant in a specified cluster.

## Syntax

### API constraints

You must obtain an OCP application service token for authentication.
...
`POST /api/v2/ob/clusters/1000001/tenants/1000005/unlock`
