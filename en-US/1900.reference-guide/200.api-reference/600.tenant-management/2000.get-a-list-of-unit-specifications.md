|slug|get-a-list-of-unit-specifications|
|---|---|
...
|--------|--------|--------|
| data | Object | The information about the unit specification. For more information, see **ObCluster's data structure**.  |
...
| maxMemorySize | Integer | The maximum memory size of the unit, in GiB.  |
| minMemorySize | Integer | The minimum memory size of the unit, in GiB.  |
