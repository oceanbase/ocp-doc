...
The API for querying the details of an OBProxy cluster.
...
| versions         | Array          | The deployment version information of OBProxy, which statistics the number of OBProxies by version. For more information, see **VersionStatInfo data structure**.  |
| topo             | Array          | The deployment topology information of OBProxy, which statistics the number of OBProxies by IDC. For more information, see **IdcStatInfo data structure**. |
...
| status           | String         | The status of OBProxy. Valid values: <li>CREATING</li><li>RUNNING</li><li>RESTARTING</li><li>UPGRADING</li><li>REFRESHING</li><li>DELETING</li><li>UNAVAILABLE</li><li>TAKINGOVER</li><li>STARTING</li><li>STOPPING</li><li>STOPPED</li><li>MOVINGOUT</li>    |
