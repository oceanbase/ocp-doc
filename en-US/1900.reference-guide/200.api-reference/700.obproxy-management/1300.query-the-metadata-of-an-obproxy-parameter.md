...
Queries the description of OBProxy parameters.
...
| allowedStringValues | String | The optional string value of the parameter.     |
...
| needRestart         | Boolean | Specifies whether to restart OBProxy for the parameter to take effect.     |
| readonly            | Boolean | Specifies whether the parameter is read-only.    |
