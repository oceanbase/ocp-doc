|slug|restarts-the-basic-processes-of-the-ocp-agent-on-multiple|
|---|---|
...
Restarts the OCP Agent processes of specified hosts.
...
|------------|----------|-----------------------|
| data       | Object   | The asynchronous DAG task information.          |
