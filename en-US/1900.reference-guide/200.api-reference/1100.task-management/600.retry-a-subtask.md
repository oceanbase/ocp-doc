...
| operation        | String      | The operation performed by the subtask. Valid values: <li>EXECUTE: normal execution</li><li>RETRY: retry</li><li>ROLLBACK: rollback</li><li>SKIP: skip</li><li>CANCEL: cancel</li>    |
