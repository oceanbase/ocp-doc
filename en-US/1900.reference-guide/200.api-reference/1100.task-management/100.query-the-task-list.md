...
| status     | StringArray | No       | RUNNING,FAILED | The status of the task. Valid values: <li>RUNNING: indicates the task is running. </li><li>FAILED: indicates the task failed. </li><li>SUCCESSFUL: indicates the task succeeded. </li>    |
| type       | String      | No       | MANUAL         | The type of the task. Valid values: <li>MANUAL: indicates a manually initiated task. </li><li>SYS_ONECE: indicates a one-time task executed by the system. </li><li>SCHEDULED: indicates a non-built-in scheduled task. </li><li>SYS_SCHEDULED: indicates a built-in scheduled task. </li>    |
...
| ├─ contents | Array    | The BasicTaskInstance array. For more information about the data structure, see **BasicTaskInstance data structure**. |
| ├─ page     | Object   | The page information. For more information, see **page parameters**.                                 |
