...
| resourceName   | String         | No       | my_ob_cluster                                 | The resource name. <li>For OceanBase cluster management and backup \& recovery, the resource name is the cluster name. </li><li>For host management, the resource name is the IP address of the host. </li><li>For tenant management, the resource name is in the format of cluster name:tenant name. </li><li>For OCP user management, the resource name is the OCP username. </li><li>For OCP cluster management, the resource name is the OCP cluster name. </li> |
...
| ├─ contents | Array    | The AuditEventHistory array. For more information about the data structure, see **Data structure of AuditEventHistory**. |
