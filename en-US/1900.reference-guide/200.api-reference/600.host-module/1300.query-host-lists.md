...
| ├─ contents | Array    | The array of hosts. For more information about the data structure, see **Host data structure**.   |
...
| kind                   | String      | The type of the host. Valid values: <li>DEDICATED_PHYSICAL_MACHINE</li><li> DEDICATED_CONTAINER  </li><li>DEDICATED_ECS </li>        |
