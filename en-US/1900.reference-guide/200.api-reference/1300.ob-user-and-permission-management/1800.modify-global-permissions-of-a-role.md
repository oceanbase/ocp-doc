...
|    Parameter     |    Type     | Required |    Example value       |       Description     |
|------------------|-------------|----------|----------------------------------|-------|
| globalPrivileges | ArrayString | Yes      | \[SELECT, CREATE\] | The list of global privileges to be granted:<li>For MySQL tenants, it is a list of global privileges.</li><li>For Oracle tenants, it is a list of system privileges.    |
