|slug|revoke-user-object-permissions|
|---|---|
...
| ├─├─ objectType  | String      | Yes      | TABLE              | The type of the database object. Valid values: <li>TABLE: table</li><li>VIEW: view</li><li>STORED_PROCEDURE: stored procedure</li>    |
