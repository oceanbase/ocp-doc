...
| type      | String  | Yes      | TOP      | The type of the metric queried: </li><li>TOP: To query the metadata of a Top N metric.   * NORMAL: To query the metadata of a common metric. </li>   |
| scope     | String  | Yes      | CLUSTER  | The scope of the metric queried: <li>CLUSTER: To query a cluster metric.   * TENANT: To query a tenant metric.   * HOST: To query a host metric.   * OBPROXY: To query an OBProxy metric.    |
...
| ├─ contents      | Array    | For more information, see **Metric Category Metadata Data**.   |
