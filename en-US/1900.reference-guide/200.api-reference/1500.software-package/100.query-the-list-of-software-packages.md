...
| type            | StringArray | No  | OB_SERVER_INSTALL_PACKAGE,OB_AGENT_INSTALL_PACKAGE | The software package type. Valid values: <li>OB_SERVER_INSTALL_PACKAGE: the OceanBase package</li><li>OCP_AGENT_INSTALL_PACKAGE: the OCP Agent package</li><li>OBPROXY_INSTALL_PACKAGE: the OBProxy package</li><li>OB_BACKUP_AGENT_INSTALL_PACKAGE: the backup and recovery software package</li>    |
