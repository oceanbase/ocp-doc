|slug|query-subtask-instance-logs|
|---|---|
...
Queries the execution logs of a subtask based on the subtask ID. The logs will automatically refresh when you query a running subtask multiple times.

## Call instructions

### Interface constraints

You must have the TASK_VIEWER permission to call this interface.
...
| ├─ log     | String   | The log information, with multi-line logs separated by \\n.   |
...
`GET /api/v2/tasks/instances/1000/subtasks/10001/log`
