|slug|get-the-latest-inspection-result-of-a-specific-object|
|---|---|
...
| tag | Object | The inspection scenario. For more information, see **InspectionTag**. |
|  startTime  |  Datetime | The inspection start time. |
|  endTime  |  Datetime | The inspection end time. |
| resultList | Array | The inspection result of the inspection item. For more information, see **InspectionItemResult**. |
...
| rules       | Array  | The inspection rules. For more information, see **InspectionItemRule**. |
| reportItems | Array  | The inspection report items. For more information, see **InspectionReportItem**. |
