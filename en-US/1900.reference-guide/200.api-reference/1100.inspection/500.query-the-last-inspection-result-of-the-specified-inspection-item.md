|slug|query-the-last-inspection-result-of-the-specified-inspection-item|
|---|---|
...
| tag | Object | The inspection scenario. For more information, see the **InspectionTag** data structure. |
|  startTime  |  Datetime | The inspection start time. |
|  endTime  |  Datetime | The inspection end time. |
| resultList | Array | The inspection result of the inspection item. For more information, see the **InspectionItemResult** data structure. |

**InspectionTag data structure**
...
**InspectionItemResult data structure**
...
| rules       | Array  | The inspection rules. For more information, see the **InspectionItemRule** data structure.  |
| reportItems | Array  | The inspection report entries. For more information, see the **InspectionReportItem** data structure. |

**InspectionItemRule data structure**

| Parameter | Type | Description |
|---------|---------|---------|
| level | String | The risk level. Valid values: **HIGH**, **MEDIUM**, and **LOW**. |
| validator  | String  | The risk discriminant.  |

**InspectionReportItem data structure**
