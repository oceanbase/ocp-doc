...
|  ├─ contents |  Array    | For more information, see **Data structure of `InspectionReport`**.    |
|  ├─ page     |  Object   | For more information, see **page data structure**.    |
...
|  tag  |  InspectionTag  | For more information, see **Data structure of InspectionTag**.  |
|  inspectionObject  |  InspectionObject  | For more information, see **Data structure of InspectionObject**.  |
...
**Data structure of `InspectionItemOverview`**

|  Parameter  |  Type  |  Description  |
|--------|--------|--------|
|  id          |  Integer  | The ID of the inspection item.  |
|  identifier  |  Integer  | The unique identifier of the inspection item.  |
|  name        |  String   | The name of the inspection item.  |
|  description |  String   | The description of the inspection item.  |
|  targetType  |  String   | The type of the inspection item.  |
|  rules       |  Array    | The inspection item rules. For more information, see **Data structure of `InspectionItemRule`**.  |

**Data structure of `InspectionItemRule`**

|  Parameter  |  Type  |  Description  |
|--------|--------|--------|
|  level      |  String  | The risk level.  |
|  validator  |  String  | The risk validator.  |

**Data structure of `InspectionReportItem`**

|  Parameter  |  Type  |  Description  |
|--------|--------|--------|
|  itemId    |  Integer  | The ID of the inspection item.  |
|  rawValue  |  String   | The unprocessed inspection result value.  |
|  value     |  String   | The inspection result value.  |
|  target    |  String   | The inspection target.  |
|  key       |  String   | The inspection result key.  |
|  level     |  Array    | The inspection result level.  |
