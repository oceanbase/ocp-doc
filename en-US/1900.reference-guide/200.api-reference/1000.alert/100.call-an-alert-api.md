...
2. The Alert Channel Configuration module of OCP provides a testing feature. You can start a test by clicking **<UI-TERM key="ocp-v2.Alarm.Channel.New.SendTestMessages">Send Test Message</UI-TERM>** . For more information, see [Create an alert channel](../../../860.alert-management/500.manage-alert-channels/100.create-an-alert-channel.md).
