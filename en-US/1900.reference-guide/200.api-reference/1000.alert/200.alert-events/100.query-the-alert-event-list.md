...
| level            | Integer  | No       | 1                             | The alert level \[1\~5\], corresponding to: Down, Critical, Alert, Caution, and Info                                                            |
...
| isSubscribedByMe | Boolean  | No       | true                          | Indicates whether the alert is subscribed by you.   |
...
| scope            | String   | The alert scope. Valid values: <li>Cluster</li><li>Tenant</li><li>Host</li><li>Service</li><li>Arbitration</li><li>Backup</li><li>OceanBaseLog</li><li>OBProxyLog</li><li>HostLog</li> |
...
| target      | String   | The target object of the alert event, which is generated based on the target template in the alert rule.   |
| summary     | String   | The summary of the alert event, which is generated based on the summary template in the alert rule.   |
| description | String   | The details of the alert event, which are generated based on the details template in the alert rule.  |
| activeAt    | Datetime | The time when the alert event is generated.    |
| resolvedAt  | Datetime | The time when the alert event is resolved.  |
| updatedAt   | Datetime | The time when the alert event is updated.   |
