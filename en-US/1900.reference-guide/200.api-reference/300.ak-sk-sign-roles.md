...
3. On the **Personal Settings** page, click **Create AccessKey Pair** in the **AccessKey** section. For more information, see [Configure personal information](../../1600.system-management-features/600.management-user-center/100.configure-personal-information.md).
