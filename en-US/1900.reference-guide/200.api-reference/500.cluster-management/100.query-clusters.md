...
| ├─ role | String | The role of the RootServer. Valid values: <li>LEADER </li><li>FOLLOWER </li> |
...
| protectionMode          | Enum     | The cluster protection mode. Valid values: <li>MAXIMUM_PERFORMANCE </li><li>MAXIMUM_PROTECTION </li><li>MAXIMUM_AVAILABILITY </li><li>UNKNOWN </li> |
| redoTransportMode       | Enum     | The log transfer mode of the cluster. Valid values: <li>SYNC: indicates synchronous log transfer. </li><li>ASYNC: indicates asynchronous log transfer. </li><li>UNKNOWN: indicates an unknown mode. </li> |
| redoTransportStatus     | Enum     | The actual log transfer status of the cluster. |
| syncStatus | String | The primary/standby synchronization status. Valid values: <li>VALID: The synchronization is complete. </li><li>DISABLED: The synchronization is disabled. </li><li>SYNCHRONIZING: The synchronization is in progress.  </li> |
