...
You can call this operation to start an OBServer node in the specified OceanBase cluster.
...
| serverId | Integer | Yes  | 1   | The ID of the OBServer node to be started. |
