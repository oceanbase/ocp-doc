...
You can call this operation to replace an OBServer node in the specified OceanBase cluster.
...
| serverId | Integer | Yes  | 1   | The ID of the OBServer node to be replaced. |
...
| skipHostOperation      | Boolean | No   | false | Specifies whether to skip the operation if an exception has occurred to the host. |
