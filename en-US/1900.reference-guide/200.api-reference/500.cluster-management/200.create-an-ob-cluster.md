...
| createExtraTenant     | Boolean   | No  | false   | Specifies whether to create a new tenant, if the cluster is in standalone mode.    |
...
| simplifiedCreateTenantParam   | Object   | No   | -   | The simplified parameters for creating a tenant, if the cluster is in standalone mode.    |
