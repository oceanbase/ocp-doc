...
You can call this operation to delete a zone from the specified OceanBase cluster.
...
|----------|---------|----|-----|-----------------------------|
|  id        |  Integer  |  Yes    |  1   | The ID of the OceanBase cluster from which you want to delete a zone. |
