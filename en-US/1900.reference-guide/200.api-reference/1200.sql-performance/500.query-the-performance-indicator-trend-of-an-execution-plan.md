|slug|query-the-performance-indicator-trend-of-an-execution-plan|
|---|---|
...
`GET /api/v2/ob/clusters/{id}/tenants/{tenantId}/plans/{uid}/trends`
...
* Data structure of planned performance sampling data
  ...
  | largeQueryPercentage        | Double    | The percentage of large queries during the execution period of the plan.                               |
  | timeoutCount        | Integer    | The number of timed out executions during the execution period of the plan.                        |
  | delayedLargeQueryPercentage | Double    | The percentage of queued large queries during the execution period of the plan.                        |
  | timeoutPercentage           | Double    | The percentage of timed out executions during the execution period of the plan.                        |
