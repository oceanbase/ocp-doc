...
`GET /api/v2/ob/clusters/{id}/tenants/{tenantId}/sql/{sqlId}/text`
...
| statement      | String   | The parameterized text of the SQL statement.         |
| supportOutline      | Boolean   | Specifies whether the SQL statement can be bound to an outline. For OBServer V2.2.70 and earlier, the first character after the SELECT keyword must be a space.         |
| tables      | String   | The table name in the SQL statement.         |
