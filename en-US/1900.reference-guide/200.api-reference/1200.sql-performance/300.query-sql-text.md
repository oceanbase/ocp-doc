...
| supportOutline      | Boolean   | Indicates whether the SQL statement can bind an outline. For OBServer versions earlier than V2.2.70, the first character after the SELECT keyword must be a space.         |
| tables      | String   | The table names in the SQL statement.         |
