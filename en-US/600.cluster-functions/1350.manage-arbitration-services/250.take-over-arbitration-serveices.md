...
5. In the **<UI-TERM key="ocp-v2.Cluster.Component.TakeOverArbitrationDrawer.TakeoverArbitrationService">Take Over Arbitration Service</UI-TERM>** panel, specify the basic information about the arbitration service.
   ...
   |---------|----------|
   | Host | The host for deploying the arbitration service. You can deploy multiple arbitration service processes on the same host. You can search for hosts by IP address.  |
