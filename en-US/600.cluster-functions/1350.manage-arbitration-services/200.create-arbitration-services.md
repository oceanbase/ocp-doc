...
4. On the **<UI-TERM key="ocp-v2.Component.ArbitrationServerList.ArbitrationServiceList">Arbitration Service List</UI-TERM>** page, click **<UI-TERM key="ocp-v2.Cluster.Arbitration.CreateArbitrationService">Create Arbitration Service</UI-TERM>**.

5. In the **<UI-TERM key="ocp-v2.src.component.ArbitrationServiceSelect.CreateArbitrationService">Create Arbitration Service</UI-TERM>** panel, configure the basic information of the arbitration service.
...
6. Click **<UI-TERM key="ocp-v2.Oracle.Component.AddObjectPrivilegeDrawer.Determine">OK</UI-TERM>**. In the window that appears, click the task ID to view the task execution status.
