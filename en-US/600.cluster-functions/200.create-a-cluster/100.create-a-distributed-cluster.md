...
<<<<<<< HEAD
     | **Cluster Name** | The name of the cluster to be created. The cluster name must be 2 to 32 characters in length and can contain uppercase and lowercase letters, digits, and underscores (_). The cluster name must start with letters and end with letters or digits.  |
=======
...
>>>>>>> 0ae970dc7029f12a65966aaebac36d94fca065bc
