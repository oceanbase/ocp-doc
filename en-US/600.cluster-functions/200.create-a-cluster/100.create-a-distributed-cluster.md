...
3. Set the basic information of the cluster. The following table describes the parameters in the **<UI-TERM key="ocp-v2.Binlog.New.BasicSettings">Basic Settings</UI-TERM>** section.
     ...
     | **<UI-TERM key="ocp-v2.Detail.Overview.ClusterName">Cluster Name</UI-TERM>** | The name of the cluster to be created. The cluster name must be 2 to 48 characters in length and can contain uppercase and lowercase letters, digits, and underscores (_). The cluster name must start with letters. |
...
6. Enable **<UI-TERM key="ocp-v2.Cluster.New.CpuOversoldSettings">CPU Overallocation Settings</UI-TERM>** and configure a CPU overprovisioning quota. You can configure the overprovisioning quota by dragging the slider or specifying a value ranging from 101% to 200% in the textbox. The default value is 120%.
...
7. Enable **<UI-TERM key="ocp-v2.OBProxy.New.ParameterSettings">Parameter Settings</UI-TERM>** and specify related cluster parameters.
...
8. Enable **<UI-TERM key="ocp-v2.Cluster.New.CustomSettings">Custom Settings</UI-TERM>** and specify custom cluster-level parameters for users (such as the OS user), paths (such as software installation paths, data disk paths, and log disk paths), and ports (such as SQL ports and RPC ports).
   ...
   * Configure the paths. The following table describes the path parameters.
      ...
      | **<UI-TERM key="ocp-v2.Cluster.New.DataDiskPath">Data Disk Path</UI-TERM>** | The default value is `/data/1`. You can change the path.  |
      ...
      Click **<UI-TERM key="ocp-v2.OBProxy.New.Test">Test</UI-TERM>** to check whether the paths can be used. If a path cannot be used, you can perform troubleshooting based on the test results, or use another path.
   ...
   * Configure the ports. The following table describes the port parameters.
      ...
      Click **<UI-TERM key="ocp-v2.Cluster.New.Test">Test</UI-TERM>** to check whether the ports are occupied. If a port is occupied, you must use another port.
...
10. In the **<UI-TERM key="ocp-v2.Detail.Overview.ConfirmationInformation">Confirm Information</UI-TERM>** dialog box, confirm the information and then click **<UI-TERM key="ocp-v2.Host.Component.BatchReinstallModal.Determine">OK</UI-TERM>**.
