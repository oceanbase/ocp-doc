...
5. In the panel that appears on the right, configure the following parameters.
    ...
    * Specify relevant information.
        ...
        To add more zones, you can click **+NewZone** in the lower part on the **Add Zone** tab.
    ...
    * Configure the startup parameters of the OBServer node. For more information, see [Overview](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001971260).
