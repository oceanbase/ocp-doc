...
2. Check the network connection.
   ...
   * Otherwise, the network connection is disconnected.
     ...
     Contact your network administrator for troubleshooting or troubleshoot and fix the network failure on your own. For more information, see [Network troubleshooting](../500.appendix/600.network-troubleshooting.md).
