|slug|ob_tenant_readonly_clog_sync_delay|
|---|---|
...
* Details example: Cluster: obcluter1, Tenant: tenant1, Host: xxx.xxx.xxx.xxx (zone: zone1), Alert: The latency for synchronizing the clogs of an OceanBase Database tenant to a read-only replica is 20 seconds, exceeding the threshold of 10 seconds.
