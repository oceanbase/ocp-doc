...
3. Check whether the OCP-Agent-related processes are running.
   ...
   * If a process is abnormal, click **Restart** next to this process in the **Processes** list. You can also run the OCP-Agent O\&M script to restart the OCP-Agent and restore the OCP-Agent service. For more information, see [OCP-Agent O\&M script](../../8.troubleshooting-1/11.appendix-3/2.ocp-agent-o-m-scripts.md).
