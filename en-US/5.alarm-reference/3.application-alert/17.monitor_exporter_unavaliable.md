...
```
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>Replace <a href="http://192.168.0.1:8089/metrics/ob/perSecond">http://192.168.0.1:8089/metrics/ob/perSecond</a> with the actual value of exporter_addr in the alert.</p>
  </main>
