...
* Overview example: ob_cluster=obcluster1-1:svr_ip=192.168.0.1 Excessive number of active OBServer sessions

* Details example: Cluster: obcluster1-1, Host: 192.168.1.1, Alert: Excessive number of active OBServer sessions. The number of active sessions on OBServer 192.168.0.1 is 1000, exceeding the threshold of 500.
