...
* Overview
   ...
   * Example: svr_ip=192.168.0.1 os_tsar_traffic_drop
* Details
   * Template: Cluster: \${ob_cluster_name}, host: \${host}, alert: \${alarm_name}, average packet losses \${value_shown} exceeds ${alarm_threshold}. 
   * Example: Cluster: obcluster, host: 192.168.0.1, alert: os_tsar_traffic_drop, average packet losses 5.2 exceeds 1. 
