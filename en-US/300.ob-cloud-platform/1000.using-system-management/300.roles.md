...
4. Find the role to edit and click **Edit** in the **Actions** column.
   ...
   The **Edit Role** page appears, where you can edit the permissions of the role. For more information, see Step 4 in [Create a role](../1000.using-system-management/200.create-role.md).
