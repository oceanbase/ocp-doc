...
|---------|-----------|
| ocp-all-in-one-4.3.6-YYYYMMDDhhmmss.el7.x86_64.tar.gz | OCP installation package, which is available on [the official website](https://en.oceanbase.com/softwarecenter).  |
