|slug|added-f5-in-the-ocp-console|
|---|---|
...
2. Create a **pool** :
   ...
   2. On the drop-down page, select **<UI-TERM key="ocp-v2.Detail.Overview.AddNode">New Node</UI-TERM>** and set Address and Service Port to the IP address and port number of the OCP-Console server, respectively.
