|slug|access-f5-through-obproxy|
|---|---|
...
2. Create a **pool** :
   ...
   3. Select the monitor that is created in step **a** from the **<UI-TERM key="ocp-v2.src.constant.compute.Available">Available</UI-TERM>** list and add it to the **<UI-TERM key="ocp-v2.Detail.Session.Statistics.ActiveNumber">Active</UI-TERM>** list.![4](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/1675959161/p269167.png)

   4. On the drop-down list, select **<UI-TERM key="ocp-v2.src.constant.binlog.AddNode">New Node</UI-TERM>** and set Address and Service Port to the IP address and port number of the OBProxy server, respectively.

   5. Click **<UI-TERM key="ocp-v2.alarm.FormListWithExclude.ObproxyClusterAndHostWithExclude.Add">Add</UI-TERM>** to add multiple nodes. After all nodes are added, click **Finished** .![5](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/1675959161/p269170.png)
