...
For more information about how to adjust the system time of an OBServer node, see [Check the NTP offset](../500.deploy-appendix-ee/200.check-the-ntp-offset.md)
