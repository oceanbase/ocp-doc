...
5. Click **<UI-TERM key="ocp-v2.ResourceManager.ResourceGroupTab.CreateResourceGroup.Ok">OK</UI-TERM>**.
   ...
   After the server is added, it appears in the server list and is in the **<UI-TERM key="ocp-v2.src.constant.backup.Initializing">Initializing</UI-TERM>** state. On the **Server Management** page, you can find the added server and click **View tasks** in the **<UI-TERM key="ocp-v2.Component.ZoneList.Operation">Actions</UI-TERM>** column of the server record to view the task progress. If the server list contains too many servers, you can search for the server by IP address in the upper part of the page.****
