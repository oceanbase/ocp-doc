|slug|metadb-resources-multi-node|
|---|---|
...
2. In the upper-right corner of the **<UI-TERM key="ocp-v2.src.hook.useMenu.Overview">Overview</UI-TERM>** page, click **<UI-TERM key="ocp-v2.Component.AddOBServerDrawer.AddObserver">Add OBServer</UI-TERM>** .
...
5. In the **<UI-TERM key="ocp-v2.Tenant.Detail.CopyDetails">Replica Details</UI-TERM>** section of the **<UI-TERM key="ocp-v2.Detail.Overview.Overview">Overview</UI-TERM>** page, click **<UI-TERM key="ocp-v2.Alarm.Channel.Editing">Edit</UI-TERM>** for the zone you want to modify.

6. Change the number of units and click **<UI-TERM key="ocp-v2.Alarm.Template.New.Ok">OK</UI-TERM>** .
