...
| OCP task log              | `/home/admin/logs/ocp/ocp.log`    | No capacity limit is set. OCP periodically clears task logs to meet the target of keeping more than 20% of disk space free. Log files updated at earlier dates are cleared first. 100 GiB of space needs to be reserved.    |
