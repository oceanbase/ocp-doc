|slug|register-an-ocp-cluster-high-availability|
|---|---|
...
1. Go to the logon page of a follower OCP cluster, enter **<UI-TERM key="ocp-v2.src.component.AddHostCredentialDrawer.UserName">Username</UI-TERM>** and **<UI-TERM key="ocp-v2.Alarm.Channel.Detail.Password">Password</UI-TERM>** , and click **<UI-TERM key="ocp-v2.page.Login.Login">Log On</UI-TERM>** .
