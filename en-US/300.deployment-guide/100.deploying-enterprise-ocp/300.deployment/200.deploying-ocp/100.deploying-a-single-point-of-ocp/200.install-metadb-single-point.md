|slug|install-metadb-single-point|
|---|---|
...
5. Click **<UI-TERM key="ocp-v2.component.Compaction.DumpPolicyDrawer.Submit">Submit</UI-TERM>**. For any errors in configurations, click **<UI-TERM key="ocp-v2.TableInfoDrawer.TableList.Reset">Reset</UI-TERM>** to restore the default configurations.
