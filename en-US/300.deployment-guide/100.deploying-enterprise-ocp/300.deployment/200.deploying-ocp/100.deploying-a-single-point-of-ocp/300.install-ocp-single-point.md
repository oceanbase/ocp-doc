...
5. After the configuration is completed, click **<UI-TERM key="ocp-v2.Auth.Role.New.Submitted">Submit</UI-TERM>**. For any errors in configurations, click **<UI-TERM key="ocp-v2.component.alarm.Search.Reset">Reset</UI-TERM>** to restore the default configurations.
