|slug|prepare-installation-media-single-point|
|---|---|
...
|-----------------------|---------|
| OAT RPM package | OceanBase Admin Toolkit (OAT) is a tool used to automatically deploy products of the OceanBase ecosystem.  <blockquote>**<UI-TERM key="ocp-v2.page.Credential.Binlog.Description">Note</UI-TERM>**</br>The OAT version must be V4.0.0 or later. </blockquote> |
