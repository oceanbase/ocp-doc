...
|------------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| data       | Object   | The information about the created tenant and asynchronous DAG tasks. For more information, see [DAG task information](../17.appendix-1/1.dag-information.md). |
