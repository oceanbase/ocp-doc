...
| whitelist | String | No | % | The whitelist of the tenant. Supported formats: <li>IP address, for example: 10.10.10.10,10.10.10.11 </li><li>Subnet/Mask, for example: 10.10.10.0/24 </li><li>Fuzzy match, for example: 10.10.10.% or 10.10.10._</li><li>Mixed format, for example: 10.10.10.10,10.10.10.11,10.10.10.%,10.10.10._,10.10.10.0/24 </li><blockquote>**Note**</br>% indicates that all clients can connect to this tenant. Default value: %.</blockquote> |
