...
| Parameter |  Type  | Required | Example value |                                                                                                                                                                                                                                          Description                                                                                                                                                                                                                                           |
|-----------|--------|----------|---------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| whitelist | String | Yes      |xxx.xxx.xxx.xxx       | The access whitelist.  * Valid values: IP addresses (for example, xxx.xxx.xxx.xxx) and CIDR blocks (for example,xxx.xxx.xxx.xxx/24).    <!-- --> * Separate multiple IP addresses with commas (,), for example, xxx.xxx.xxx.xxx,192.168.0.0/24.    <!-- --> * xxx.xxx.xxx.xxx indicates that no access is allowed from any IP address.    |
