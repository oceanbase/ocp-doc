...
The Actions column provides the **Add OBProxy** and **Delete** options. Click a cluster name in the **OBProxy Cluster Name** column, the details page of the corresponding cluster appears. For more information, see [Create an OBProxy cluster](../../8.obproxy/1.create-an-obproxy-cluster-2.md), [Add an OBProxy](../../8.obproxy/6.add-obproxy.md), [Delete an OBProxy cluster](../../8.obproxy/11.delete-obproxy-cluster-1.md).
