...
For more information about host management, see [Add a host](../../6.host-features/2.add-a-host-1.md), [Download logs](../../4.cluster-features/2.basic-operations/10.download-log.md), [Restart the OCP Agent](../../6.host-features/4.restart-the-ocp-agent.md), and [Reinstall the OCP Agent](../../6.host-features/5.reinstall-ocp-agent.md).
