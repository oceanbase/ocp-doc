...
| [Cluster backup and recovery](../../4.cluster-features/10.cluster-backup-and-recovery/1.cluster-backup-and-recovery.md)     | You can view the basic information, details, and backup strategies about the backup and recovery of the current cluster on the cluster backup and recovery page.  |
