...
Choose **System Management \> Security** . You can view all [default roles](../15.appendix-2/18.ocp-default-roles.md) of OCP and their respective permissions on the **Role Management** tab. 
