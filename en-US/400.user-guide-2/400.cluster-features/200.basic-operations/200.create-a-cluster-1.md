...
4. In the **Parameter Configurations** section, configure the cluster parameters.
  ...
  <main id="notice" type='explain'>
    ...
    <li>If no cluster parameter template is available, you can click <strong>Create Cluster Template</strong> to create one. For more information, see <a href="../1200.cluster-parameter-template-management.md">Manage cluster parameter templates</a>.</li>
    </ul>
  </main>
