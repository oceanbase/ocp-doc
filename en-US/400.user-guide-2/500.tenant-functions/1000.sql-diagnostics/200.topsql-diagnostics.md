...
* View TopSQL information.
  ...
  4. You can click the SQL text of an SQL statement to go to the SQL Details page of the statement.
     ...
     * On the **Execution Plans** tab, you can view the execution plans of the SQL statement. For more information, see [View the execution plans of an SQL statement](../1000.sql-diagnostics/500.view-sql-details.md).
