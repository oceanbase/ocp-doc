...
A: The default account for logging on to OCP is `admin` and the default password can be obtained by contacting technical support. We recommend that you change the password of the admin user after you log on OCP for the first time.
