|slug|connect-the-alarm-to-the-dingding|
|---|---|
...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.alarm.FormListWithExclude.ClusterWithExclude.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.page.Alarm.Alarm">Alert Center</UI-TERM>**
...
2. On the alert details page, click the **<UI-TERM key="ocp-v2.Alarm.Channel.Detail.AlarmChannel">Alert Channel</UI-TERM>** tab.
...
6. Click **<UI-TERM key="ocp-v2.component.OperationConfig.ModifyParameterDrawer.Submit">Submit</UI-TERM>**.
...
Use curl to check whether a test message can be sent. If no, click **<UI-TERM key="ocp-v2.Alarm.Channel.NewChannel">Create Channel</UI-TERM>** on the alert details page and configure a network proxy in the **<UI-TERM key="ocp-v2.Channel.FormComponent.WeComForm.Proxy">Proxy</UI-TERM>** field in the **<UI-TERM key="ocp-v2.Cluster.New.BasicSettings">Basic Settings</UI-TERM>** section.
