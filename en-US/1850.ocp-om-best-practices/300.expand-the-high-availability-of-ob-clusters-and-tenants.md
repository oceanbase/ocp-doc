...
* An OceanBase cluster must be in **Running** state before you add a zone to the cluster.
* The hosts for deploying OBServer nodes are available in OCP.
* A tenant must be in **Running** state before you add a replica to the tenant.
