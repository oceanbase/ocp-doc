|slug|ocp-migration-tenant-unit|
|---|---|
...
* **<UI-TERM key="ocp-v2.Auth.Role.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.page.Iframe.ResourceManagement">Resource Management</UI-TERM>** menu of **<UI-TERM key="ocp-v2.Cluster.Component.ClusterList.ClusterList">Clusters</UI-TERM>**
...
1. Initiate a unit migration task.
   ...
   Choose **<UI-TERM key="ocp-v2.Cluster.Component.ClusterList.ClusterList">Clusters</UI-TERM>** > **<UI-TERM key="ocp-v2.page.Iframe.ResourceManagement">Resource Management</UI-TERM>** > **<UI-TERM key="ocp-v2.Detail.Resource.UnitDistribution">Unit Distribution</UI-TERM>**, click the resource unit that you want to migrate, and specify the migration destination in the dialog box that appears.
...
2. Wait until the unit migration is complete.
   ...
   The **<UI-TERM key="ocp-v2.Detail.Resource.UnitDistribution">Unit Distribution</UI-TERM>** page displays the resource units that are being migrated.
