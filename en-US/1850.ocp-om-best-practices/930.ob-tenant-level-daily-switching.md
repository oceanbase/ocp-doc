|slug|ob-tenant-level-daily-switching|
|---|---|
...
* Make sure that you have the following permissions:
  ...
  * To switch a primary tenant to the STANDBY role, make sure that you have the following permissions:
    ...
    * **<UI-TERM key="ocp-v2.Auth.Role.AddRole.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Backup.Overview.Statistics.SummaryInvestingComZa">Overview</UI-TERM>** menu of **<UI-TERM key="ocp-v2.Tenant.New.Tenant">Tenants</UI-TERM>**
  * To switch all primary tenants in a cluster to the STANDBY role, make sure that you have the following permissions:
...
2. In the left-side navigation pane, click **<UI-TERM key="ocp-v2.Detail.Resource.Unit.Tenant">Tenants</UI-TERM>**. On the **<UI-TERM key="ocp-v2.Detail.Resource.Unit.Tenant">Tenants</UI-TERM>** tab, select the target primary tenant to go to its **<UI-TERM key="ocp-v2.src.util.menu.SummaryInvestingComZa">Overview</UI-TERM>** page.

3. On the page that appears, click the More icon in the upper-right corner and select **<UI-TERM key="ocp-v2.Detail.Component.SwitchoverModal.DailySwitchover">Switchover</UI-TERM>** from the menu.

4. In the dialog box that appears, confirm the information and click **<UI-TERM key="ocp-v2.Detail.Component.DailyChangeTenantModal.StartSwitching">Start Switch</UI-TERM>** .
...
2. In the left-side navigation pane, click **<UI-TERM key="ocp-v2.Cluster.Component.ClusterList.ClusterList">Clusters</UI-TERM>**. On the **<UI-TERM key="ocp-v2.Cluster.Component.ClusterList.ClusterList">Clusters</UI-TERM>** page, go to the **<UI-TERM key="ocp-v2.src.hook.useMenu.Overview">Overview</UI-TERM>** page of the target cluster.

3. Click the More icon in the upper-right corner and select **<UI-TERM key="ocp-v2.Detail.Overview.TenantDailySwitching">Tenant Switchover</UI-TERM>** from the menu.

4. In the dialog box that appears, select the tenants for which you want to perform a switchover and click **<UI-TERM key="ocp-v2.Detail.Overview.DailySwitching">Switchover</UI-TERM>**.
