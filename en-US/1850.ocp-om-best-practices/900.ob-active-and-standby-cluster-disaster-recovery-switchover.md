|slug|ob-active-and-standby-cluster-disaster-recovery-switchover|
|---|---|
...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.AddRole.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Backup.Overview.Statistics.SummaryInvestingComZa">Overview</UI-TERM>** menu of **<UI-TERM key="ocp-v2.page.Cluster.ClusterList">Clusters</UI-TERM>**
* The current cluster is a standby cluster and is in **<UI-TERM key="ocp-v2.src.constant.compute.NormalOperation">Running</UI-TERM>** state.
...
* The current cluster is in **<UI-TERM key="ocp-v2.src.constant.oceanbase.MaximumPerformance">Maximum Performance</UI-TERM>** mode.
* The version of the current cluster is OceanBase Database V2.2.76 or later and earlier than V4.0.

## Procedure

1. Log on to the follower OceanBase Cloud Platform (OCP) cluster and click **<UI-TERM key="ocp-v2.page.Cluster.ClusterList">Clusters</UI-TERM>** in the left-side navigation pane. On the **<UI-TERM key="ocp-v2.Cluster.Component.ClusterList.ClusterList">Clusters</UI-TERM>** page, click the name of a standby cluster.
2. On the page that appears, click the More icon in the upper-right corner and select **<UI-TERM key="ocp-v2.Detail.Overview.PrimaryClusterDisasterRecoverySwitchover">Switch to Primary Cluster: Disaster Recovery</UI-TERM>**.
