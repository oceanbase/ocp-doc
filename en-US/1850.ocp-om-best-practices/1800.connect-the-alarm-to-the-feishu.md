|slug|connect-the-alarm-to-the-feishu|
|---|---|
...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.Detail.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Detail.Analyze.TimesChart.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.src.hook.useMenu.AlarmCenter">Alert Center</UI-TERM>**
...
2. On the alert details page, click the **<UI-TERM key="ocp-v2.Alarm.Event.Detail.AlertChannel">Alert Channel</UI-TERM>** tab.
...
6. Click **<UI-TERM key="ocp-v2.Detail.Component.AddUserDrawer.Submitted">Submit</UI-TERM>**.
