|slug|customize-alarm-push-through-http|
|---|---|
...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.Detail.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.component.HostSelect.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.page.Alarm.Alarm">Alert Center</UI-TERM>**
...
1. In the left-side navigation pane, choose **<UI-TERM key="ocp-v2.page.Alarm.Alarm">Alert Center</UI-TERM>**.

2. On the alert details page, click the **<UI-TERM key="ocp-v2.Alarm.Channel.Detail.AlarmChannel">Alert Channel</UI-TERM>** tab.

3. On the **<UI-TERM key="ocp-v2.Alarm.Channel.Detail.AlarmChannel">Alert Channel</UI-TERM>** tab, click **<UI-TERM key="ocp-v2.Alarm.Channel.NewChannel">Create Channel</UI-TERM>**.
...
4. Configure the HTTP alert channel. For DingTalk, you must configure the following information:
   ...
   1. Basic settings
      ...
      | Recipient Field | Yes | Select **<UI-TERM key="ocp-v2.src.constant.alarm.UserId">User ID</UI-TERM>**.  |
...
6. Click **<UI-TERM key="ocp-v2.Oracle.Component.ModifyObjectPrivilegeModal.Submitted">Submit</UI-TERM>**.
