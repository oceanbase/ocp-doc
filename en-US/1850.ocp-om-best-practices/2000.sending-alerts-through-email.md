|slug|sending-alerts-through-email|
|---|---|
...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.Detail.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Component.LogTypeSelect.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.src.hook.useMenu.AlarmCenter">Alert Center</UI-TERM>**
...
2. On the alert details page, click the **<UI-TERM key="ocp-v2.Alarm.Subscriptions.New.AlarmChannel">Alert Channel</UI-TERM>** tab.

3. On the **<UI-TERM key="ocp-v2.page.Alarm.AlarmChannel">Alert Channel</UI-TERM>** tab, click **<UI-TERM key="ocp-v2.Alarm.Channel.New.CreateAChannel">Create Channel</UI-TERM>**.
...
6. Click **<UI-TERM key="ocp-v2.Alarm.Subscriptions.New.Submit">Submit</UI-TERM>**.
