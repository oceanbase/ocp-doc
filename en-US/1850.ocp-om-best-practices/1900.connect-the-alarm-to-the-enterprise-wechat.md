|slug|connect-the-alarm-to-the-enterprise-wechat|
|---|---|
...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.AddRole.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Detail.Component.RestartModal.All">All</UI-TERM>** menu of the **<UI-TERM key="ocp-v2.src.hook.useMenu.AlarmCenter">Alert Center</UI-TERM>**
...
* You have created and configured a WeChat Enterprise chatbot. Each chatbot can send at most 20 messages to a group per minute
   ...
   1. Manage chatbots in group settings.
      ...
      In an enterprise WeChat group, click the **<UI-TERM key="ocp-v2.Cluster.Component.MachineResource.SeeMore">More</UI-TERM>** icon, and then choose **Group Robot** > **Add Group Robot**.
...
1. In the left-side navigation pane, choose **<UI-TERM key="ocp-v2.src.hook.useMenu.AlarmCenter">Alert Center</UI-TERM>**.

2. On the alert details page, click the **<UI-TERM key="ocp-v2.page.Alarm.AlarmChannel">Alert Channel</UI-TERM>** tab.

3. On the Alert Channel tab, click **<UI-TERM key="ocp-v2.Alarm.Channel.New.CreateAChannel">Create Channel</UI-TERM>**.
...
4. Configure the WeChat Enterprise alert channel.
   ...
   2. Message settings
      ...
      2. You can modify the message structure. Here is a sample of the message structure of the default format:
         ...
         Set **<UI-TERM key="ocp-v2.Alarm.Channel.New.AlertMessageFormat">Alert Message Format</UI-TERM>** to `Markdown`. You can enter `${}` to introduce a variable.
...
Use curl to check whether a test message can be sent. If no, click **<UI-TERM key="ocp-v2.Alarm.Channel.New.CreateAChannel">Create Channel</UI-TERM>** on the alert details page and configure a network proxy in the **<UI-TERM key="ocp-v2.Channel.FormComponent.FeishuForm.Proxy">Proxy</UI-TERM>** field in the **<UI-TERM key="ocp-v2.Binlog.New.BasicSettings">Basic Settings</UI-TERM>** section.
