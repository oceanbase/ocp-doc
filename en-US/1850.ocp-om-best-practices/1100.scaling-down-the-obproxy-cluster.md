|slug|scaling-down-the-obproxy-cluster|
|---|---|
...
2. In the left-side navigation pane, click **OBProxy**. On the page that appears, click the name of the target OBProxy cluster to go to its **<UI-TERM key="ocp-v2.src.util.menu.SummaryInvestingComZa">Overview</UI-TERM>** page.

3. In the OBProxy list, find a target OBProxy and click **<UI-TERM key="ocp-v2.page.Credential.Binlog.Delete">Delete</UI-TERM>** in the **<UI-TERM key="ocp-v2.Alarm.Rule.Operation">Actions</UI-TERM>** column. You can also select multiple OBProxies and click **<UI-TERM key="ocp-v2.Tenant.Detail.BatchDelete">Batch Delete</UI-TERM>**.
