...
|------------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| data       | Object   | The information about the created tenant and asynchronous DAG tasks. For more information, see [DAG task information](/en-US/5.api-reference/15.api-appendix/1.task-information.md). |
