...
|------------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| data       | Object   | The information about the asynchronous task. For more information, see[Task](/en-US/5.api-reference/15.api-appendix/1.task-information.md) [information](/en-US/5.api-reference/15.api-appendix/1.task-information.md). |
