...
* **Method 1**: Log in to the OceanBase Cloud Platform (OCP) console and go to the tenant overview page. In the left-side navigation pane, click **Performance Monitoring**.
