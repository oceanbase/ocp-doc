...
* **<UI-TERM key="ocp-v2.Auth.Role.Detail.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Auth.Role.Detail.All">All</UI-TERM>** menu of **<UI-TERM key="ocp-v2.Information.Detail.CollectDetails.HostList">Hosts</UI-TERM>**
...
5. On the **<UI-TERM key="ocp-v2.Host.Detail.Surveillance">Monitoring</UI-TERM>** tab, click the **Host Processes** tab to view the monitoring data of host processes.
   ...
   * If **<UI-TERM key="ocp-v2.Component.overview.AutomaticRefresh">Auto Refresh</UI-TERM>** is disabled, you can click **<UI-TERM key="ocp-v2.SQLDiagnosis.Digest.LastHour">Last 1 Hour</UI-TERM>** and then select a time range to view the monitoring data of the last hour, last day, last week, or a custom time range.
   * If **<UI-TERM key="ocp-v2.Detail.Transaction.AutomaticRefresh">Auto Refresh</UI-TERM>** is enabled, the system displays the real-time monitoring data of the host.
