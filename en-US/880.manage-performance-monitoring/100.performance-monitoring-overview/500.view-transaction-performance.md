...
5. Click the **Transaction** tab and view the transaction monitoring data of the tenant.
   ...
   * Drill down to view monitoring data in different dimensions: If you find an abnormal metric such as a long transaction response time on the **Tenant Dimension** tab, perform drill-down analysis to identify the faulty server. Click the **Drill-down Analysis** icon in the upper-right corner of the trend chart to view the drill-down analysis details. The **Transaction** tab supports the following drill-down dimensions: tenant > OBServer node.
