...
* **Method 2**: Log in to the OCP console and go to the host details page. Click the **Monitoring** tab to go to the **Host Performance** tab.

* **Method 3**: Log in to the OCP console. In the left-side navigation pane, click **Performance Monitoring**to go to the **OceanBase Cluster** tab.
...
* To view the performance monitoring data of hosts by using **Method 2**, make sure that you have the following permissions:
  ...
  * **Menu Permissions**: **Menu Permissions**: Permission on the **All** menu of **Hosts**
