...
4. In the **<UI-TERM key="ocp-v2.MultiCluster.RegisterOcp.BasicOcpInformation">Current OCP Basic Information</UI-TERM>** section, click **<UI-TERM key="ocp-v2.MultiCluster.Detail.DisassociateTheActiveStandbyRelationship">Unbind from Leader Cluster</UI-TERM>** .
...
5. In the confirmation dialog box, click **<UI-TERM key="ocp-v2.MultiCluster.Detail.DisassociateTheActiveStandbyRelationship">Unbind from Leader Cluster</UI-TERM>** .
...
4. In the left-side navigation pane, choose **<UI-TERM key="ocp-v2.src.util.menu.SystemManagement">System Management</UI-TERM>** \> **<UI-TERM key="ocp-v2.src.util.menu.OcpMultiClusterMode">OCP Multi-cluster Mode</UI-TERM>** .

5. In the **<UI-TERM key="ocp-v2.MultiCluster.RegisterOcp.BasicOcpInformation">Current OCP Basic Information</UI-TERM>** section of the **Leader \& Follower Details** tab, click **<UI-TERM key="ocp-v2.MultiCluster.Detail.DisassociateTheActiveStandbyRelationship">Unbind from Leader Cluster</UI-TERM>** .

   The following message appears: **<UI-TERM key="ocp-v2.MultiCluster.Detail.TheActiveStandbyRelationshipIs">The follower OCP is unbound from the leader OCP.</UI-TERM>** The system returns to the **<UI-TERM key="ocp-v2.MultiCluster.RegisterOcp.WelcomeToMultiClusterMode">Welcome to Multi-cluster mode</UI-TERM>** page.
