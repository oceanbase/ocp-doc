...
3. In the **<UI-TERM key="ocp-v2.MultiCluster.RegisterOcp.BasicOcpInformation">Current OCP Basic Information</UI-TERM>** section of the **Leader \& Follower Details** tab, click **<UI-TERM key="ocp-v2.MultiCluster.Detail.SwitchToPrimaryOcp">Switch to Leader OCP</UI-TERM>** .
