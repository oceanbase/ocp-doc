...
4. Filter the suspicious SQL statements.
   ...
   1. Specify the filter conditions.
     ...
     * **Keyword**: If you specify a keyword, the SQL statements that contain the keyword are displayed in the query result. The keywords filter SQL statements in the same way as the SQL LIKE operator. The entered strings are automatically prefixed and suffixed with a percent sign (%).
