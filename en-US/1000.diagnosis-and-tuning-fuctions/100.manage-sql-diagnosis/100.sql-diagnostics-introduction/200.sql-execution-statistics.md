...
Metrics in the **<UI-TERM key="ocp-v2.Component.filter.ColumnManagement">Column Management</UI-TERM>** dialog box are classified into four types: time model metrics, common metrics, basic information metrics, and execution plan metrics.
...
| **<UI-TERM key="ocp-v2.Monitor.AddMonitor.VisualizationsTable.IndicatorItem">Metric</UI-TERM>** | **<UI-TERM key="ocp-v2.Alarm.Template.Description">Description</UI-TERM>** |
| --- | --- |
...
| **<UI-TERM key="ocp-v2.Monitor.AddMonitor.VisualizationsTable.IndicatorItem">Metric</UI-TERM>** | **<UI-TERM key="ocp-v2.src.component.AddHostCredentialDrawer.Description">Description</UI-TERM>**                                                                                                                                                                                                                           |
| --- |-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| **<UI-TERM key="ocp-v2.Monitor.AddMonitor.VisualizationsTable.IndicatorItem">Metric</UI-TERM>** | **<UI-TERM key="ocp-v2.src.component.AddOBCredentialModal.Description">Description</UI-TERM>** |
| --- | --- |
...
| **<UI-TERM key="ocp-v2.Monitor.AddMonitor.VisualizationsTable.IndicatorItem">Metric</UI-TERM>** | **<UI-TERM key="ocp-v2.Alarm.Rule.Description">Description</UI-TERM>** |
| --- | --- |
