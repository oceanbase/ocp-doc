...
* **Method 1**: Log in to the OceanBase Cloud Platform (OCP) console. In the left-side navigation pane, click **OceanBase Autonomy Service**. On the page that appears, find the target cluster and click its name to go to the **Real-time Diagnostics** page. Then, click the **Transaction Diagnostics** tab.
...
On the **Transaction Diagnostics** page, you can view the information about running large transactions in the following columns: **Transaction Hash**, **Session ID**, **Transaction Type**, **Affected Rows**, **Execution Time Elapsed**, and **Maximum Log Volume of Single Participant**.
...
You can click the SQL text of an executed SQL statement to go to the **SQL Details** page and view the details of the SQL statement.
