|slug|sql-with-high-cpu-load-under-the-tenant|
|---|---|
...
Click **<UI-TERM key="ocp-v2.Component.CustomColumn.CustomColumns.2">Custom Column</UI-TERM>**. In the dialog box that appears, set **<UI-TERM key="ocp-v2.Component.CustomColumn.ColumnExpression">Column Expression</UI-TERM>** to **@executions * @avgCpuTime**, and set **<UI-TERM key="ocp-v2.Component.CustomColumn.ColumnName">Column Name</UI-TERM>** to **TotalCpuTime**.
