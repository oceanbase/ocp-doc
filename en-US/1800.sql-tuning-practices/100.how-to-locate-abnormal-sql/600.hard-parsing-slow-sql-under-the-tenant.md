|slug|hard-parsing-slow-sql-under-the-tenant|
|---|---|
...
On the **TopSQL** tab, click **<UI-TERM key="ocp-v2.Component.filter.ColumnManagement">Column Management</UI-TERM>** and select **<UI-TERM key="ocp-v2.SQLDiagnosis.attributes.slowSqlAttributes.ResolutionTime">Parsing Time</UI-TERM>**. Then sort the SQL statements on the tab by the **<UI-TERM key="ocp-v2.SQLDiagnosis.attributes.slowSqlAttributes.ResolutionTime">Parsing Time</UI-TERM>** column.
