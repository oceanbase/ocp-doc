|slug|sql-executed-remotely-under-the-tenant|
|---|---|
...
On the **TopSQL** tab, click **<UI-TERM key="ocp-v2.Component.filter.ColumnManagement">Column Management</UI-TERM>** and select **Proportion of Remote Plans (%)**. Then sort the SQL statements on the tab by the **Proportion of Remote Plans (%)** column.
