...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.MenuPermissions">Menu Permissions</UI-TERM>**: **<UI-TERM key="ocp-v2.Auth.Role.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **Tags** menu of **<UI-TERM key="ocp-v2.src.util.menu.SystemManagement">System Management</UI-TERM>**
...
3. Go to the **<UI-TERM key="ocp-v2.component.TenantList.Label">Tag</UI-TERM>** page and click **<UI-TERM key="ocp-v2.page.Tags.TagList.CreateATag">Create Tag</UI-TERM>**.
...
4. In the panel that appears, specify the tag information. The following table describes the parameters.
   ...
   * By default, the system allows you to add one tag. To add more tags, click **<UI-TERM key="ocp-v2.alarm.FormListWithExclude.TenantWithExclude.Add">Add</UI-TERM>** in the lower part.
   * You can click **<UI-TERM key="ocp-v2.src.constant.backup.Delete">Delete</UI-TERM>** next to a tag to delete it.
