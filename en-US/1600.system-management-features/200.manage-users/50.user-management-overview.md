...
* **Default roles**
    ...
    You can choose **<UI-TERM key="ocp-v2.src.util.menu.SystemManagement">System Management</UI-TERM>** > **<UI-TERM key="ocp-v2.page.Auth.UserManagement">User Management</UI-TERM>** to view all [default roles](200.manage-a-role/600.ocp-default-roles.md) and their permissions on the **<UI-TERM key="ocp-v2.Oracle.Component.AddOracleUserOrRoleDrawer.Role">Role</UI-TERM>** tab.
...
On the **<UI-TERM key="ocp-v2.src.constant.auditEvent.Role">Role</UI-TERM>** tab, you can search for roles, view information about a role such as the role name, organization, resource permissions, menu permissions, and users to which the role is assigned, and perform common O&M operations. For more information, see [Create a role](200.manage-a-role/100.create-a-role.md), [Copy a role](200.manage-a-role/400.copy-a-role.md), [View a role](200.manage-a-role/200.view-a-role.md), [Edit a role](200.manage-a-role/300.edit-a-role.md), and [Delete a role](200.manage-a-role/500.delete-a-role.md).
