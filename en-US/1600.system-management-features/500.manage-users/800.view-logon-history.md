...
4. Click **Search** .
   ...
   * You can click a username in the logon list to go to the user details page. For more information about the user details page, see [View users](../500.manage-users/300.view-the-user-details-page.md).
