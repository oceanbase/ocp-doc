...
On the **<UI-TERM key="ocp-v2.Inspection.Item.ConfigItem.ConfigureInspectionItems">Configure Inspection Items</UI-TERM>** page, you can view the name, type, inspection scenario, description, and inspection rule of each inspection item, and enable or disable the inspection items.
...
| **<UI-TERM key="ocp-performance-report.ReportTables.ParameterStatInfo.ServerParamInfoTable.Parameter">Parameter</UI-TERM>** | **<UI-TERM key="ocp-v2.src.component.AddArbitrationDrawer.Description">Description</UI-TERM>** |
| --- | --- |
...
The **<UI-TERM key="ocp-v2.page.Inspection.InspectionHistory">Inspection History</UI-TERM>** tab displays all initiated inspection tasks. It summarizes the levels and number of security risks of inspection objects.
