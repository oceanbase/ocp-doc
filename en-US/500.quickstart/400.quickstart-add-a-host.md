...
3. In the upper-right corner of the page, click **<UI-TERM key="ocp-v2.page.Host.AddHost">Add Host</UI-TERM>** .
...
7. Select the credential for logging on to the host from the **<UI-TERM key="ocp-v2.src.constant.information.Credentials">Credential</UI-TERM>** **<UI-TERM key="ocp-v2.src.util.Seconds">s</UI-TERM>** drop-down list.
...
9. Click **<UI-TERM key="ocp-v2.Binlog.Component.FlowBinlogModal.Ok">OK</UI-TERM>** .
