...
4. Click **<UI-TERM key="ocp-v2.page.Login.Login">Log On</UI-TERM>**.
...
In the upper-right corner of the OCP console, click the username and select **<UI-TERM key="ocp-v2.Layout.Header.ExitLogin">Log Off</UI-TERM>**. For more information, see [Log off](../1600.system-management-features/700.manage-user-center/400.log-out.md).
