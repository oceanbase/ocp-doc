|slug|create-a-sampling-strategy-for-recovery|
|---|---|
...
* **<UI-TERM key="ocp-v2.Auth.Role.AddRole.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **Restore** menu of **<UI-TERM key="ocp-v2.Backup.Guide.BackupAndRestoration">Backup & Recovery</UI-TERM>**
...
2. In the left-side navigation pane, choose **<UI-TERM key="ocp-v2.src.constant.compute.BackupAndRestoration">Backup & Recovery</UI-TERM>** **>** **<UI-TERM key="ocp-v2.Restore.SamplingStrategy.New.Recovery">Recovery</UI-TERM>**. In the upper-right corner of the page, click **<UI-TERM key="ocp-v2.Backup.Restore.CreateASamplingPolicy">New Sampling Strategy</UI-TERM>**.

3. Specify **<UI-TERM key="ocp-v2.Component.AddSamplingInspectStrategy.SamplingPolicyName">Sampling Strategy Name</UI-TERM>**, **<UI-TERM key="ocp-v2.Arbitration.ArbitrationGroup.UpgradeArbitrationGroup.Cluster">Cluster</UI-TERM>**, and **<UI-TERM key="ocp-v2.Restore.SamplingStrategy.Detail.SamplingTime">Sampled At</UI-TERM>** in the **<UI-TERM key="ocp-v2.Component.AddSamplingInspectStrategy.SamplingConfiguration">Sampling Settings</UI-TERM>** section.
...
5. Click **<UI-TERM key="ocp-v2.Binlog.New.Submit">Submit</UI-TERM>**.
