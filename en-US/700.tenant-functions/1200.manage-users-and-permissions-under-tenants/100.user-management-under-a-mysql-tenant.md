...
6. To create a user, click **Create User** in the upper-right corner.
...
7. Change the password of a user: Click **Change Password** in the **Actions** column of the user. In the dialog box that appears, change the password.

8. Modify the permissions of a user: Click **Modify Permission** in the **Actions** column of the user to modify the global permissions and database permissions of the user.

9. Delete a user: Click **Delete** in the **Actions** column of the user to delete the corresponding user. Deleting a user may affect the business that involves this user. Proceed with caution.
