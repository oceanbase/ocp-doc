...
* **Method 1**: Log in to the OCP console, go to the **Tenants** page, and click **Create Tenant** in the upper-right corner.

* **Method 2**: Log in to the OCP console, go to the **Overview** page of a cluster, and click **Create Tenant** in the upper-right corner.

* **Method 3**: Log in to the OCP console, go to the **Overview** page of a cluster, select **Tenant Management** in the left-side navigation pane, and click **Create Tenant** in the upper-right corner.

* **Method 4**: Log in to the OCP console, go to the **Overview** page of a tenant, click the **More** icon in the upper-right corner, and select **Create Tenant**.
