...
3. On the **Tenants** tab, click **Create Tenant**.
...
4. Configure the parameters in the **Basic Information** section. The required parameters and their descriptions are listed in the following table.
   ...
   | **Character Set and Encoding** | <ul><li> In MySQL mode, the supported character sets are utf8mb4, binary, gbk, gb18030, and latin1. The default character set is utf8mb4 in MySQL mode.    </li><li> In Oracle mode, the supported character sets are utf8mb4, gbk, and gb18030. The default character set is utf8mb4 in Oracle mode.  </li> </ul> |
