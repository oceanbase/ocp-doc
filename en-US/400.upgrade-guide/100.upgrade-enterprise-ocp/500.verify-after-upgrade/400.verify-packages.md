...
2. In the left-side navigation pane, choose **System Management > System Package Management**. Check whether the software package information is properly displayed on the **<UI-TERM key="ocp-v2.page.Package.Package">Packages</UI-TERM>** page.
