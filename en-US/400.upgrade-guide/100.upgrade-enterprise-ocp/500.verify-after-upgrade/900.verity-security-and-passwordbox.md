...
3. Check whether information is properly displayed on the **<UI-TERM key="ocp-v2.Auth.Org.SharedResourceDrawer.OceanbaseCluster">OceanBase Cluster</UI-TERM>** and **<UI-TERM key="ocp-v2.Component.ZoneList.AddOBServerDrawer.Host">Host</UI-TERM>** tabs.
