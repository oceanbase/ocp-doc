...
2. Click **<UI-TERM key="ocp-v2.src.hook.useMenuOptions.TaskCenter">Task Center</UI-TERM>** in the upper part of the page. Check whether the previously initiated tasks are properly displayed on the **<UI-TERM key="ocp-v2.Task.Detail.Task">Task</UI-TERM>** page.
