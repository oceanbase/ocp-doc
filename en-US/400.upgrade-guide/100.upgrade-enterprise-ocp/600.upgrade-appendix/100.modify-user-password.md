...
3. On the **<UI-TERM key="ocp-v2.Detail.Session.List.User">User</UI-TERM>** tab, click **<UI-TERM key="ocp-v2.Oracle.UserOrRoleDetail.ChangePassword">Change Password</UI-TERM>** in the **<UI-TERM key="ocp-v2.Restore.SamplingStrategy.Operation">Actions</UI-TERM>** column of the user list.
...
5. Click **<UI-TERM key="ocp-v2.Report.Component.GenerateReportModal.Determine">OK</UI-TERM>**.
