...
3. On the **OCP** tab of the **Product Management** page, find the target OCP and click its name in the **<UI-TERM key="ocp-v2.MultiCluster.Detail.Name">Name</UI-TERM>** column to go to the details page.
   >
   > **<UI-TERM key="ocp-v2.page.Credential.Binlog.Description">Note</UI-TERM>**
   >
   >If there are too many OCPs, you can also search for the target OCP by product name in the upper-right corner of the page.

4. In the upper-right corner of the details page, click **<UI-TERM key="ocp-v2.Detail.Component.UpgradeModal.Upgrade">Upgrade</UI-TERM>**.

   ![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/ocp/420/420-en/%E5%8D%87%E7%BA%A7OCP.png)

5. In the **<UI-TERM key="ocp-v2.Binlog.Component.UpgradeBinlogModal.Upgrade">Upgrade</UI-TERM>** dialog box, enter the required information.

   The following table describes the related fields.

   | **<UI-TERM key="ocp-v2.SQLDiagnosis.Component.IndexTable.ColumnName">Field</UI-TERM>** | **<UI-TERM key="ocp-v2.component.OperationConfig.List.Description">Description</UI-TERM>** |
   |---------|------------|
