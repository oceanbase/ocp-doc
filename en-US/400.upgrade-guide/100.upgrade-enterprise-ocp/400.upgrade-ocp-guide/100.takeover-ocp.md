...
4. On the **Take Over OCP** page, set the related parameters.
   ...
   1. Set the basic parameters, as shown in the following table.
      ...
      | **<UI-TERM key="ocp-performance-report.ReportTables.ParameterStatInfo.ZoneParamInfoTable.Parameter">Parameter</UI-TERM>** | **<UI-TERM key="ocp-v2.component.alarm.RuleDetail.Description">Description</UI-TERM>** |
      |--------|-----------|
   ...
   3. Set the load balancing parameters, which are optional, as shown in the following table.
      ...
      | **<UI-TERM key="ocp-performance-report.ReportTables.ParameterStatInfo.ServerParamInfoTable.Parameter">Parameter</UI-TERM>** | **<UI-TERM key="ocp-v2.src.component.AddHostDrawer.DescriptionOptional">Description</UI-TERM>** |
      |----------|------------|
...
5. After the configuration for taking over OCP is completed, click **<UI-TERM key="ocp-v2.component.Compaction.MergePolicyDrawer.Submit">Submit</UI-TERM>**. For any errors in the configuration, click **<UI-TERM key="ocp-v2.TrendAndOutline.SQLHistory.Reset">Reset</UI-TERM>** to restore the default configuration.
