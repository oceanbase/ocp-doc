...
**<UI-TERM key="ocp-v2.page.Overview.SqlDiagnosis">SQL Diagnostics</UI-TERM>** > **SlowSQL**: OCP V4.3.2 supports displaying sample data and displaying detailed parameters of sample data on the details page.
...
* **<UI-TERM key="ocp-v2.Task.TaskObjectAndType.BinlogService">Binlog service</UI-TERM>**: The binlog instance list can display standby instances, and allows you to restart and stop standby instances.
