...
2. Enter the OCP username and password on the logon page.
   ...
   > **Notice**
   >
   > The username is admin, and the default password is root. To ensure account security, we recommend that you change the default password after you log on for the first time. For more information, see [Change your logon password](../4.user-guide-2/3.features/8.user-center/2.change-the-logon-password-1.md).
