...
| whitelist | String | No | % | The whitelist of the tenant. Supported formats: <li>IP address, for example: xxx.xxx.xxx.xxx,xxx.xxx.xxx.xxx </li><li>Subnet/Mask, for example: xxx.xxx.xxx.xxx/24 </li><li>Fuzzy match, for example: 10.10.10.% or 10.10.10._</li><li>Mixed format, for example: xxx.xxx.xxx.xxx,xxx.xxx.xxx.xxx,10.10.10.%,10.10.10._,xxx.xxx.xxx.xxx/24 </li><blockquote>**Note**</br>% indicates that all clients can connect to this tenant. Default value: %.</blockquote> |
