...
| whitelist        | String  | No       | %                  | The whitelist of the tenant. Supported formats: IP address example: xxx.xxx.xxx.xxx,xxx.xxx.xxx.xxx Subnet/mask example: xxx.xxx.xxx.xxx/24 Fuzzy match example: 10.10.10.% or 10.10.10._Mixed format example: xxx.xxx.xxx.xxx,xxx.xxx.xxx.xxx,xxx.xxx.xxx.xxx.10.10._,_,xxx.xxx.xxx.xxx/24 Note: % indicates that the tenant can access the database from any client. Default value: %.                                                                                                            |
