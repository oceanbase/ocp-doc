|slug|add-a-connectable-oceanbase-cluster|
|---|---|
...
* Make sure that you have the following permissions:
  ...
  * **<UI-TERM key="ocp-v2.Auth.Role.AddRole.MenuPermissions">Menu Permissions</UI-TERM>**: Permission on the **<UI-TERM key="ocp-v2.Detail.Overview.Overview">Overview</UI-TERM>** menu of **OBProxy**
...
6. Click **<UI-TERM key="ocp-v2.Component.AddZoneDrawer.Ok">OK</UI-TERM>**.
